...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('leave_applications', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('casual_leave_due_as_on')->default(0)->nullable();
            $table->unsignedBigInteger('casual_leave_availed')->default(0)->nullable();
            $table->unsignedBigInteger('casual_balance_due')->default(0)->nullable();
            $table->unsignedBigInteger('earned_leave_due_as_on')->default(0)->nullable();
            $table->unsignedBigInteger('earned_leave_availed')->default(0)->nullable();
            $table->unsignedBigInteger('earned_balance_due')->default(0)->nullable();
            $table->unsignedBigInteger('medical_leave_due_as_on')->default(0)->nullable();
            $table->unsignedBigInteger('medical_leave_availed')->default(0)->nullable();
            $table->unsignedBigInteger('medical_balance_due')->default(0)->nullable();
