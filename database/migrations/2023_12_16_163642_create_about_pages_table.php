...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('about_pages', function (Blueprint $table) {
            ...
            $table->string('section_five_col_one_title');
            $table->string('section_five_ceo_sign')->nullable()->comment('image');
            $table->string('section_five_ceo_name')->nullable();
            $table->string('section_five_ceo_designation')->nullable();
            $table->string('section_five_ceo_facebook_account_link')->nullable();
            $table->string('section_five_ceo_twitter_account_link')->nullable();
            $table->string('section_five_ceo_whatsapp_account_link')->nullable();
            $table->text('section_five_col_two_content')->nullable();
            $table->string('section_five_col_two_title')->nullable();
            $table->string('section_five_col_two_list_1')->nullable();
            $table->string('section_five_col_two_list_2')->nullable();
            $table->string('section_five_col_two_list_3')->nullable();
            $table->string('section_five_col_two_list_4')->nullable();
            $table->string('section_six_card_one_title');
            $table->string('section_six_card_one_count');
            $table->string('section_six_card_one_icon')->nullable();
            $table->text('section_six_card_one_short_description');
            $table->string('section_six_card_two_title');
            $table->string('section_six_card_two_count');
            $table->string('section_six_card_two_icon')->nullable();
            $table->text('section_six_card_two_short_description');
            $table->string('section_six_card_three_title');
            $table->string('section_six_card_three_count');
            $table->text('section_six_card_three_short_description');
            $table->string('section_six_card_three_icon')->nullable();
            $table->string('section_six_card_four_title');
            $table->string('section_six_card_four_count');
