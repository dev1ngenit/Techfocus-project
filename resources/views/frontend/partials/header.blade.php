<!-- Top Bar Start -->
<div
class="container-fluid d-sm-none d-md-block"
style="background-color: var(--sub-color)">
<div
  class="row text-white top-bar"
  style="background-color: var(--sub-main-color)">
  <div
    class="col-lg-9"
    style="background-color: var(--sub-color);
      clip-path: polygon(0 0, 95% 0%, 100% 102%, 0% 100%);"></div>
  <div class="col-lg-3" style="background-color: var(--sub-main-color)">
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          <div
          ...
          >
            <div class="dropdown pb-1">
              ...
              <ul
                class="dropdown-menu extra-dropdown"
                aria-labelledby="dropdownMenuButton1"
              >
                <li>
                  <a class="dropdown-item top-dropdown" href="#"
                    >English</a
                  >
                </li>
                <li>
            ...
            <div class="popover__wrapper me-5">
              ...
              <div class="popover__content text-start">
                <button class="btn signin mb-2">Connect</button>
                <div class="text-muted">
                  First time here?
                  <a href="" class="main-color">Inscrivez-vous</a>
                </div>
                <hr class="text-muted" />
                ...
                <hr class="text-muted" />
                <ul
                  class="account p-0 text-muted text-start"
                  style="font-size: 7px"
                >
                  <li>
                    Sign in to your manufacturer account
                    <a target="_blank" class="main-color"
...
<div class="container-fluid">
  ...
  <a class="navbar-brand mb-2" href="index.html" data-aos="fade-right">
    <img
      src="https://i.ibb.co/dD1P3Wt/Demo-Logo.png"
      height="60px"
      alt=""
    />
  </a>
  ...
  <div class="d-lg-none d-sm-block">
    ...
    <nav id="meny">
      <div
        class=""
        style="z-index: 9999; padding-top: 1rem; padding-left: 28rem"
      >
        <!--Mobile Head -->
        <p class="text-danger">
              ...
              <div class="container">
                <div class="row">
                  ...
                  <div class="col-md-4">
                    ...
                    >
                      <img
                        src="https://i0.wp.com/bootstrapcreative.com/wp-bc/wp-content/uploads/2022/07/beginners-guide-to-hubspot-cms-cover.png?w=200&ssl=1"
              ...
              <div class="container">
                <div class="row">
                  ...
                  <div class="col-md-4">
                    <a
                      target="_blank"
                      href="#shop/jake-portfolio-hubspot-theme/"
                    >
                      <img
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav ms-auto">
                  ...
                  <div class="accordion-item mb-2">
                    <h2 class="accordion-header" id="flush-headingOne">
                      <button
                        ...
                        data-bs-target="#flush-collapseOne25"
                        aria-expanded="false"
                        aria-controls="flush-collapseOne25"
                      >
                  ...
                  <div class="accordion-item mb-2">
                    <h2 class="accordion-header" id="flush-headingTwo">
                      <button
                        ...
                        type="button"
                        data-bs-toggle="collapse"
                        data-bs-target="#flush-collapseTwo66"
                        aria-expanded="false"
                        aria-controls="flush-collapseTwo66"
                      >
                        <p class="p-0 m-0 accordion-button-area p-2">
                  ...
                  <div class="accordion-item mb-2">
                    ...
                    >
                      <button
                        ...
                        type="button"
                        data-bs-toggle="collapse"
                        data-bs-target="#flush-collapseThree77"
                        aria-expanded="false"
                        aria-controls="flush-collapseThree77"
                      >
                        <p class="p-0 m-0 accordion-button-area p-2">
                ...
                >
                  <div class="accordion-item mb-2">
                    <h2 class="accordion-header" id="flush-headingOne1">
                      <button
                        class="accordion-button accordion-triger p-2 collapsed"
                        type="button"
                        data-bs-toggle="collapse"
                        data-bs-target="#flush-collapseOne189"
                        aria-expanded="false"
                  ...
                  <div class="accordion-item mb-2">
                    <h2 class="accordion-header" id="flush-headingTwo">
                      <button
                        ...
                        type="button"
                        data-bs-toggle="collapse"
                        data-bs-target="#flush-collapseTwo210"
                        aria-expanded="false"
                  ...
                  <div class="accordion-item mb-2">
                    ...
                    >
                      <button
                        ...
                        type="button"
                        data-bs-toggle="collapse"
                        data-bs-target="#flush-collapseThree36"
                        aria-expanded="false"
      ...
      <li class="nav-item">
        <a class="nav-link" data-aos="fade-right" href="catalogs.html"
          >Catalog</a
        >
      </li>
      <li class="nav-item dropdown">
      ...
      <li class="nav-item">
        <a class="nav-link" data-aos="fade-right" href="RFQ.html"
          >RFQ</a
        >
      </li>
      <li class="nav-item">
