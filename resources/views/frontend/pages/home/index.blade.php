    ...
    <div class="swiper bannerSwiper">
        <div class="swiper-wrapper">
            <div class="swiper-slide">
                <img src="https://i.ibb.co/72jrMpF/54667.jpg" class="img-fluid" alt="" />
            </div>
            <div class="swiper-slide">
                <img src="https://i.ibb.co/pfYZQK4/54574v2.jpg" class="img-fluid" alt="" />
            </div>
            <div class="swiper-slide">
                <img src="https://i.ibb.co/W3X5G2H/54361.jpg" class="img-fluid" alt="" />
            </div>
        </div>
            ...
            <div class="col-lg-12">
                <div class="container">
                    <div class="row g-2">
                                ...
                                <div class="accordion-item mb-2">
                                    <h2 class="accordion-header" id="flush-headingOne">
                                        <button class="accordion-button p-3 collapsed" type="button"
                                            ...
                                            <p class="p-0 m-0 accordion-button-area p-2 ps-0">
                                                <span class="ms-0"> </span>
                                            </p>
                                            <div class="d-flex align-items-center w-100">
                                                <img src="./assets/img/Icon.svg" class="" alt="" />
                                                <p class="mb-0 ms-2">
                        ...
                        <div class="col-lg-6 col-sm-12 my-3 pe-0">
                            <div class="accordion accordion-flush" id="accordionFlushExample">
                                <div class="accordion-item mb-2">
                                    <h2 class="accordion-header" id="flush-headingOne">
                                        <button class="accordion-button p-3 collapsed" type="button"
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <div class="holder-main-text">
                            <h6 style="width: 20%; line-height: 25px">
                                WHY YOU NEED US?
                            </h6>
