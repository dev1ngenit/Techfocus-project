    ...
    <div class="container my-4">
        <div class="row align-items-center">
            <div class="container px-4">
                <div class="row gx-5">
                    <div class="col-lg-3">
                        <div class="pt-4 pb-2 text-center">Read our buying guides and make the right choice</div>
                        <div class="d-flex justify-content-center">
                            <img src="https://guide.directindustry.com/wp-content/themes/framework/media/GA-icon_di.svg"
