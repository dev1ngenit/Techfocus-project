...
<section class="ban_sec">
    <div class="container-fluid p-0">
        <div class="ban_img">
            <img src="https://templates.thememodern.com/industris/images/subheader-about.jpg" alt="banner" border="0">
            <div class="ban_text">
                <strong>
                    About Us
                </strong>
                ...
                <div class="row align-items-center bg-white p-5">
                    <div class="col-lg-7">
                        <div>
                            ...
                            <div class="pt-4">
                                <a href="" class="text-btn main-color">Learn more about employee ownership at SEL <i
                                        class="fa-solid fa-chevron-right"></i></a>
                            </div>
                        </div>
                    </div>
...
<section class="ban_sec-action">
    <div class="container p-0">
        <div class="ban_img-action">
            <img src="https://s3.amazonaws.com/thumbnails.venngage.com/template/942a9fe0-01ee-441a-97c0-b9c89b85e0a8.png" alt="banner" border="0">
        ...
        <div class="row align-items-center">
            <div class="col-lg-6" style="border-right: 1px solid var(--secondary-color)">
                <div class="me-4">
                    ...
                    <div>
                        <img class="img-fluid" src="https://templates.thememodern.com/industris/images/sign.png" alt="">
                    </div>
                    <div class="d-flex">
            ...
            <div class="col-lg-6">
                <div class="ms-4">
                    ...
                    <ul class="ms-0 ps-0">
                        <li class="pt-3"><a href=""><i class="fa-regular fa-circle-check pe-2 main-color"></i>Flexible
                                solutions</a></li>
                        <li class="pt-3"><a href=""><i class="fa-regular fa-circle-check pe-2 main-color"></i>Flexible
                                solutions</a></li>
                        <li class="pt-3"><a href=""><i class="fa-regular fa-circle-check pe-2 main-color"></i>Flexible
