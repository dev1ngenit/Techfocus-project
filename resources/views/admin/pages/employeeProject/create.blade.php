                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 mb-2">
                                            <label for="validationCustom04"
                                                class="form-label required mb-0">Type</label>
                                            <select
                                        ...
                                        <div class="col-md-3 mb-2">
                                            <label for="validationCustom04" class="form-label required mb-0">Start
                                                Date</label>
                                            <input type="date"
                                        ...
                                        <div class="col-md-3 mb-2">
                                            <label for="validationCustom04" class="form-label required mb-0">End
                                                Date</label>
                                            <input type="date"
                                        ...
                                        <div class="col-md-3 mb-2">
                                            <label for="validationCustom04"
                                                class="form-label required mb-0">Supervisor</label>
                                        ...
                                        <div class="col-md-3 mb-2">
                                            <label for="validationCustom04" class="form-label required mb-0">Assigned
                                                Employee</label>
                                            <select
                                        ...
                                        <div class="col-md-3 mb-2">
                                            <label for="validationCustom04" class="form-label required mb-0">Project
                                                Status</label>
                                            <select
                                        ...
                                        <div class="col-md-3 mb-2">
                                            <label for="validationCustom04"
                                                class="form-label required mb-0">Review</label>
                                        ...
                                        <div class="col-md-3 mb-2">
                                            <label for="validationCustom04"
                                                class="form-label required mb-0">Weight</label>
                                            <input type="text"
                                        ...
                                        <div class="col-md-4 mb-2">
                                            <label for="validationCustom04" class="form-label required mb-0">Kpi
                                                Rating</label>
                                            <input type="number"
                                        ...
                                        <div class="col-md-4 mb-2">
                                            <label for="validationCustom04"
                                                class="form-label required mb-0 @error('total_working_day') is-invalid @enderror">Total
                                                Working Day</label>
                                        ...
                                        <div class="col-md-12 mb-2">
                                            <label for="longText" class="form-label required mb-0">Long Text</label>
