                                        ...
                                        <div class="col-lg-4">
                                            <div class="fv-row mb-3">
                                                ...
                                                <select class="form-select form-select-solid form-select-sm"
                                                    name="brand_id[]" id="field2" multiple multiselect-search="true"
                                            ...
                                            <div class="fv-row mb-3">
                                                ...
                                                <select class="form-select form-select-solid form-select-sm"
                                                    name="category_id[]" id="field2" multiple multiselect-search="true"
                                            ...
                                            <div class="fv-row mb-3">
                                                ...
                                                <select class="form-select form-select-solid form-select-sm"
                                                    name="industry_id[]" id="field2" multiple multiselect-search="true"
                                                    multiselect-select-all="true" multiselect-max-items="2">
                                            ...
                                            <div class="fv-row mb-3">
                                                ...
                                                <select class="form-select form-select-solid form-select-sm"
                                                    name="solution_id[]" id="field2" multiple multiselect-search="true"
                                                    multiselect-select-all="true" multiselect-max-items="2">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-sm-12">
                                            <div class="row">
                                                ...
                                                <div class="col-md-4 mb-2">
                                                    <label for="validationCustom01"
                                                        class="form-label required ">Author</label>
                                                    <input type="text"
                                                        class="form-control form-control-solid form-control-sm"
