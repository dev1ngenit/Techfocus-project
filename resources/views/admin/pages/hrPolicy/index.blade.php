...
@section('content')
                    ...
                    <div class="card-body">
                        <table
                            ...
                            <tbody class="fw-bold text-gray-600 text-center">
                                @if ($hrPolicys)
                                    @foreach ($hrPolicys as $hrPolicy)
                                        <tr class="odd">
                                            <td>
                                                {{ $loop->iteration }}
                                            </td>
                                            <td>
                                                {{ $hrPolicy->countryName() }}
                                            </td>
                                            <td>
                                                {{ $hrPolicy->title }}
                                            </td>
                                            <td>
                                                {{ $hrPolicy->effective_date }}
                                            </td>
                                            <td>
                                                {{ $hrPolicy->version }}
                                            </td>
                                            <td>
                                                <span
                                                    class="badge {{ $hrPolicy->status == 'active' ? 'bg-success' : ($hrPolicy->status == 'inactive' ? 'bg-danger' : ($hrPolicy->status == 'archived' ? 'bg-info' : '')) }}">{{ $hrPolicy->status }}</span>
                                            </td>
                                            <td class="d-flex justify-content-between align-items-center">
                                                <a href="#"
                                                    class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1"
                                                    data-bs-toggle="modal"
                                                    data-bs-target="#hrPoliciesViewModal_{{ $hrPolicy->id }}">
                                                    <i class="fa-solid fa-expand"></i>
                                                </a>
                                                <a href="#"
                                                    class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1"
                                                    data-bs-toggle="modal"
                                                    data-bs-target="#hrPoliciesEditModal_{{ $hrPolicy->id }}">
                                                    <i class="fa-solid fa-pen"></i>
                                                </a>
                                                <a href="{{ route('admin.hr-policy.destroy', $hrPolicy->id) }}"
    ...
    <div class="modal fade" id="hrPoliciesAddModal" data-backdrop="static">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content rounded-0 border-0 shadow-sm">
                ...
                <form action="{{ route('admin.hr-policy.store') }}" class="needs-validation" method="post" novalidate>
                    @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 mb-2">
                                    ...
                                    <select class="form-select form-select-solid form-select-sm"
                                        name="dynamic_category_id" data-dropdown-parent="#hrPoliciesAddModal"
                                ...
                                <div class="col-lg-6 mb-2">
                                    <label for="validationCustom04" class="form-label required mb-0">Effective
                                        Date</label>
                                ...
                                <div class="col-lg-6 mb-2">
                                    <label for="validationCustom04" class="form-label required mb-0">Expiration
                                        Date</label>
                                    <input type="date" class="form-control form-control-solid form-control-sm"
                                        id="validationCustom01" placeholder="Enter Expiration Date"
                                ...
                                <div class="col-lg-6 mb-2">
                                    ...
                                    <input type="text" class="form-control form-control-solid form-control-sm"
                                        id="validationCustom01" placeholder="Enter Version" name="version" required>
    ...
    {{-- Edit Modal --}}
    @foreach ($hrPolicys as $hrPolicy)
        <div class="modal fade" id="hrPoliciesEditModal_{{ $hrPolicy->id }}" data-backdrop="static">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content rounded-0 border-0 shadow-sm">
                    <div class="modal-header p-2 rounded-0">
                    ...
                    <form action="{{ route('admin.hr-policy.update', $hrPolicy->id) }}" class="needs-validation"
                                ...
                                <div class="row">
                                    <div class="col-lg-6 mb-2">
                                        <label for="validationCustom04" class="form-label required mb-0">Country
                                            Name</label>
                                        <select class="form-select form-select-solid form-select-sm" name="country_id"
                                            data-dropdown-parent="#hrPoliciesEditModal_{{ $hrPolicy->id }}"
                                            data-control="select2" data-placeholder="Select an option"
                                            data-allow-clear="true" required>
                                            <option></option>
                                            @foreach (getAllCountry() as $country)
                                                <option @selected($hrPolicy->country_id == $country->id) value="{{ $country->id }}">
                                                    {{ $country->name }}</option>
                                            @endforeach
                                        </select>
                                        <div class="invalid-feedback"> Please Select Country Name. </div>
                                    ...
                                    <div class="col-lg-6 mb-2">
                                        ...
                                        <select class="form-select form-select-solid form-select-sm" name="company_id"
                                            ...
                                            <option></option>
                                            @foreach ($companies as $company)
                                                <option @selected($hrPolicy->company_id == $company->id) value="{{ $company->id }}">
                                                    {{ $company->name }}</option>
                                            @endforeach
                                        </select>
                                        <div class="invalid-feedback"> Please Select Company Name. </div>
                                    ...
                                    <div class="col-lg-6 mb-2">
                                        ...
                                        <select class="form-select form-select-solid form-select-sm"
                                            ...
                                            <option></option>
                                            @foreach ($dynamicCategories as $dynamicCategory)
                                                <option @selected($hrPolicy->dynamic_category_id == $dynamicCategory->id) value="{{ $dynamicCategory->id }}">
                                    ...
                                    <div class="col-lg-6 mb-2">
                                        ...
                                        <select class="form-select form-select-solid form-select-sm" name="status"
                                            ...
                                            <option></option>
                                            <option @selected($hrPolicy->status == 'active') value="active">Active</option>
                                            <option @selected($hrPolicy->status == 'inactive') value="inactive">Inactive</option>
                                            <option @selected($hrPolicy->status == 'archived') value="archived">Archived</option>
                                        </select>
                                        <div class="invalid-feedback">Please Choose Status. </div>
                                    </div>
                                    <div class="col-lg-6 mb-2">
                                    ...
                                    <div class="col-lg-6 mb-2">
                                        <label for="validationCustom04" class="form-label required mb-0">Effective
                                            Date</label>
                                        <input type="date" class="form-control form-control-solid form-control-sm"
                                            id="validationCustom01" placeholder="Enter Effective Date"
                                            name="effective_date" value="{{ $hrPolicy->effective_date }}" required>
                                        <div class="invalid-feedback"> Please Enter Effective Date. </div>
                                    </div>
                                    <div class="col-lg-6 mb-2">
                                        <label for="validationCustom04" class="form-label required mb-0">Expiration
                                        ...
                                        <input type="date" class="form-control form-control-solid form-control-sm"
                                            id="validationCustom01" placeholder="Enter Expiration Date"
                                            name="expiration_date" value="{{ $hrPolicy->expiration_date }}" required>
                                        <div class="invalid-feedback"> Please Enter Expiration Date. </div>
                                    </div>
                                    <div class="col-lg-6 mb-2">
                                        <label for="validationCustom04" class="form-label required mb-0">Version</label>
                                        <input type="text" class="form-control form-control-solid form-control-sm"
                                            ...
                                            value="{{ $hrPolicy->version }}" required>
                                        <div class="invalid-feedback"> Please Enter Version. </div>
                                    </div>
                                    <div class="col-lg-12 mb-2">
                                        ...
                                        <textarea rows="1" name="description" class="form-control form-control-sm form-control-solid"
                                            placeholder="Enter Description">{{ $hrPolicy->description }}</textarea>
                                        <div class="invalid-feedback"> Please Enter Version. </div>
                                    </div>
                                </div>
                            </div>
    ...
    {{-- View Modal --}}
    @foreach ($hrPolicys as $hrPolicy)
        <div class="modal fade" id="hrPoliciesViewModal_{{ $hrPolicy->id }}" data-backdrop="static">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content rounded-0 border-0 shadow-sm">
                    <div class="modal-header p-2 rounded-0">
