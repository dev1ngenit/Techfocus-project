            ...
            <div class="card">
                <div class="main_bg card-header py-2 main_bg align-items-center">
                    ...
                    <div class="col-lg-7 col-sm-12 d-flex justify-content-start">
                        <h4 class="text-white p-0 m-0 fw-bold">Employee Create Form</h4>
                    </div>
                </div>
                <div class="card-body p-0 pt-1">
                    <div class="row gx-0">
                            ...
                            <ul class="nav nav-tabs nav-pills border-0 flex-row flex-md-column mb-3 mb-md-0 fs-6"
                                ...
                                <li class="nav-item w-md-290px my-1" role="presentation">
                                    <a class="nav-link p-5 rounded-0 tab-trigger" data-bs-toggle="tab"
                                        href="#family-emergency" aria-selected="false" role="tab"
                                        tabindex="-1">Emergency
                                        Contact Info</a>
                                </li>
                                <li class="nav-item w-md-290px my-1" role="presentation">
                                    <a class="nav-link p-5 rounded-0 tab-trigger" data-bs-toggle="tab"
                        ...
                        <div class="col-lg-10 px-4 p-2">
                            <form id="productForm" method="post" action="{{ route('admin.employee.store') }}"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-3 pt-1">
                                                        <div class="mb-1">
                                                            ...
                                                            <textarea type="text" name="permanent_address" class="form-control form-control-sm form-control-solid"
                                                                placeholder="Enter Permanent Address" id="" cols="30" rows="1"></textarea>
                                                            <div class="invalid-feedback"> Please Enter Name.</div>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-3 pt-1">
                                                    ...
                                                    <div class="col-lg-3 pt-1">
                                                        <div class="mb-1">
                                                            ...
                                                            <textarea type="text" name="current_address" class="form-control form-control-sm form-control-solid"
                                                                placeholder="Enter Current Address " id="" cols="30" rows="1"></textarea>
                                                            <div class="invalid-feedback"> Please Enter Name.</div>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-3 pt-1">
                                                    ...
                                                    <div class="col-lg-3 pt-1">
                                                        <div class="mb-1">
                                                            <label class="p-0 text-start text-black">What Turns You On
                                                                Off</label>
                                                            <textarea name="what_turns_you_on_off" class="form-control form-control-sm form-control-solid"
                                                                placeholder="Enter What Turns You On Off" id="" cols="30" rows="1"></textarea>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-3 pt-1">
                                                        <div class="mb-1">
                                                            <label class="p-0 text-start text-black">Preference In
                                                                Professional
                                                                Life</label>
                                                            <textarea name="preference_in_professional_life" class="form-control form-control-sm form-control-solid"
                                                                placeholder="Enter Preference In Professional Life" id="" cols="30" rows="1"></textarea>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-3 pt-1">
                                                        <div class="mb-1">
                                                            <label class="p-0 text-start text-black">Action In Negative
                                                                Situation</label>
                                                            <textarea name="action_in_negative_situation" class="form-control form-control-sm form-control-solid"
                                                                placeholder="Enter Action In Negative Situation" id="" cols="30" rows="1"></textarea>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-3 pt-1">
                                                        <div class="mb-1">
                                                            ...
                                                            <input type="number"
                                                                class="form-control form-control-sm form-control-solid"
                                                                name="total_years_of_job_experience" id=""
                                                                maxlength="2" max="2" min="1"
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="row">
                                                            <div class="col-lg-4 pt-1">
                                                                <div class="mb-1">
                                                                    <label class="p-0 text-start text-black">Recent Job
                                                                        Info
                                                                        One
                                                                        Company
                                                                        Name</label>
                                                            ...
                                                            <div class="col-lg-6 pt-1">
                                                                <div class="mb-1">
                                                                    <label class="p-0 text-start text-black">Recent Job
                                                                        ...
                                                                        One
                                                                        Address</label>
                                                                    <textarea type="text" name="recent_job_info_one_address" class="form-control form-control-sm form-control-solid"
                                                                        placeholder="Enter Recent Job Info One Address" id="" cols="30" rows="1"></textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                            ...
                                                            <div class="col-lg-6 pt-1">
                                                                <div class="mb-1">
                                                                    <label class="p-0 text-start text-black">Recent Job
                                                                        ...
                                                                        Two
                                                                        Address</label>
                                                                    <textarea type="text" name="recent_job_info_two_address" class="form-control form-control-sm form-control-solid"
                                                                        placeholder="Enter Recent Job Info Two Address" id="" cols="30" rows="1"></textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-6 pt-1">
                                                                <div class="mb-1">
                                                                    <label class="p-0 text-start text-black">Other Training
                                                                        Information
                                                                        Technical</label>
                                                                    <textarea type="text" name="other_training_information_technical_training"
                                                                        class="form-control form-control-sm form-control-solid" placeholder="Enter Other Training Information Technical"
                                                            ...
                                                            <div class="col-lg-6 pt-1">
                                                                <div class="mb-1">
                                                                    <label class="p-0 text-start text-black">Other Training
                                                                        Information
                                                                        Certificate</label>
                                                                    <textarea type="text" name="other_training_information_certificate_course"
                                                                        class="form-control form-control-sm form-control-solid" placeholder="Enter Other Training Information Certificate"
                                                                        id="" cols="30" rows="1"></textarea>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-6 pt-1">
                                                            ...
                                                            <div class="col-lg-3 pt-1">
                                                                <div class="mb-1">
                                                                    ...
                                                                    <textarea type="text" name="academic_achievements" class="form-control form-control-sm form-control-solid"
                                                                        placeholder="Enter Academic Achievements " id="" cols="30" rows="1"></textarea>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-3 pt-1">
                                                                <div class="mb-1">
                                                                    <label class="p-0 text-start text-black">Professional
                                                                        Achievements </label>
                                                                    <textarea type="text" name="professional_achievements" class="form-control form-control-sm form-control-solid"
                                                                        placeholder="Enter Professional Achievements " id="" cols="30" rows="1"></textarea>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-3 pt-1">
                                                                <div class="mb-1">
                                                                    ...
                                                                    <textarea type="text" name="social_achievements" class="form-control form-control-sm form-control-solid"
                                                                        placeholder="Enter Social Achievements " id="" cols="30" rows="1"></textarea>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-3 pt-1">
                                                                <div class="mb-1">
                                                                    ...
                                                                    <textarea type="text" name="personal_achievements" class="form-control form-control-sm form-control-solid"
                                                                        placeholder="Enter Personal Achievements " id="" cols="30" rows="1"></textarea>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-3 pt-1">
                                                                <div class="mb-1">
                                                            ...
                                                            <div class="col-lg-3 pt-1">
                                                                <div class="mb-1">
                                                                    <label class="p-0 text-start text-black">Professional
                                                                        Reference
                                                                        Address</label>
                                                                    <textarea type="text" name="professional_reference_address"
                                                                        class="form-control form-control-sm form-control-solid" placeholder="Enter Professional Reference Address"
                                                                        id="" cols="30" rows="1"></textarea>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-3 pt-1">
                                                            ...
                                                            <div class="col-lg-3 pt-1">
                                                                <div class="mb-1">
                                                                    <label class="p-0 text-start text-black">Replative
                                                                        Reference
                                                                        Address</label>
                                                                    <textarea type="text" name="relative_reference_address" class="form-control form-control-sm form-control-solid"
                                                                        placeholder="Enter Replative Reference Address" id="" cols="30" rows="1"></textarea>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-3 pt-1">
                                                                <div class="mb-1">
                                                ...
                                                <div class="row mt-4 justify-content-end">
                                                    <div class="d-flex align-items-center justify-content-between p-0">
                                                        <a class="btn btn-lg btn-info rounded-0 tab-trigger-previous"
                                                            data-bs-target="#personal-info" aria-selected="false"
                                                            role="tab" tabindex="-1">
                                                            Previous
                                                            <span class="svg-icon svg-icon-4 ms-1 me-0">
                                                                <i class="fa-solid fa-arrow-right"></i>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-3 pt-1">
                                                        <div class="mb-1">
                                                            ...
                                                            <textarea type="text" name="emergency_contact_information_address"
                                                                class="form-control form-control-sm form-control-solid" placeholder="Enter Emergency Contact Information Address "
                                                                id="" cols="30" rows="1"></textarea>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-3 pt-1">
                                                        <div class="mb-1">
                                                            <label class="p-0 text-start text-black">Total
                                                                Brother's</label>
                                                            <input type="number"
                                                                class="form-control form-control-sm form-control-solid"
                                                    ...
                                                    <div class="col-lg-3 pt-1">
                                                        <div class="mb-1">
                                                            <label class="p-0 text-start text-black">Siblings Contact Info
                                                                One </label>
                                                            <textarea type="text" name="siblings_contact_info_one" class="form-control form-control-sm form-control-solid"
                                                                placeholder="Enter Siblings Contact Info One " id="" cols="30" rows="1"></textarea>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-9 pt-1">
                                                        <div class="mb-1">
                                                            <label class="p-0 text-start text-black">Siblings Contact Info
                                                                Two </label>
                                                            <textarea type="text" name="siblings_contact_info_two" class="form-control form-control-sm form-control-solid"
                                                                placeholder="Enter Siblings Contact Info Two " id="" cols="30" rows="1"></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row mt-4 justify-content-end">
                                                    <div class="d-flex align-items-center justify-content-between">
                                                        <a class="btn btn-lg btn-info rounded-0 tab-trigger-previous"
                                                            data-bs-target="#job-academic" aria-selected="false"
                                                            role="tab" tabindex="-1">
                                                            Previous
                                                            <span class="svg-icon svg-icon-4 ms-1 me-0">
                                                                <i class="fa-solid fa-arrow-right"></i>
