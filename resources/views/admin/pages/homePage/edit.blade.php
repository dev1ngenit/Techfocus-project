                                                ...
                                                <div class="row">
                                                        ...
                                                        <div class="fv-row mb-3">
                                                            ...
                                                            <select
                                                                ...
                                                                @foreach (getAllCountry() as $country)
                                                                    <option @selected($country->id == $homePage->country_id)
                                                    ...
                                                    <div class="col-lg-4">
                                                        <div class="fv-row mb-3">
                                                            ...
                                                            <input type="text"
                                                                ...
                                                                name="section_one_name"
                                                                value="{{ $homePage->section_one_name }}"
                                                    ...
                                                    <div class="col-lg-4">
                                                        <div class="fv-row mb-3">
                                                            ...
                                                            <input type="text"
                                                                ...
                                                                value="{{ $homePage->section_one_badge }}"
                                                                id="validationCustom01"
                                                    ...
                                                    <div class="col-lg-4">
                                                        <div class="fv-row mb-3">
                                                            ...
                                                            <input type="text"
                                                                ...
                                                                value="{{ $homePage->section_one_title }}"
                                                                id="validationCustom01"
                                                    ...
                                                    <div class="col-lg-4">
                                                        <div class="fv-row mb-3">
                                                            ...
                                                            <textarea rows="1" name="section_one_link"
                                                                class="form-control form-control-sm form-control-solid @error('section_one_link') is-invalid @enderror"
                                                                placeholder="Enter Section One Link">{{ $homePage->section_one_link }}</textarea>
                                                    ...
                                                    <div class="col-lg-4">
                                                        <div class="fv-row mb-3">
                                                            ...
                                                            <input type="text"
                                                                ...
                                                                name="section_one_button"
                                                                value="{{ $homePage->section_one_button }}"
                                                                id="validationCustom01"
                                                ...
                                                <div class="row mt-5 justify-content-end">
                                                    <div class="d-flex align-items-center justify-content-between">
                                                        <a class="btn btn-lg btn-info rounded-0 tab-trigger-previous"
                                                            data-bs-target="#section-one" aria-selected="false"
                                                            role="tab" tabindex="-1">
                                                            Previous
                                                            <span class="svg-icon svg-icon-4 ms-1 me-0">
                                                                <i class="fa-solid fa-arrow-right"></i>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-4">
                                                        <div class="fv-row mb-3">
                                                            ...
                                                            <input type="text"
                                                                class="form-control form-control-solid form-control-sm @error('section_three_name') is-invalid @enderror"
                                                                name="section_three_name"
                                                                value="{{ $homePage->section_three_name }}"
                                                                id="validationCustom01"
                                                    ...
                                                    <div class="col-lg-4">
                                                        <div class="fv-row mb-3">
                                                            ...
                                                            <input type="text"
                                                                class="form-control form-control-solid form-control-sm @error('section_three_badge') is-invalid @enderror"
                                                                name="section_three_badge"
                                                                value="{{ $homePage->section_three_badge }}"
                                                                id="validationCustom01"
                                                    ...
                                                    <div class="col-lg-4">
                                                        <div class="fv-row mb-3">
                                                            ...
                                                            <input type="text"
                                                                class="form-control form-control-solid form-control-sm @error('section_three_title') is-invalid @enderror"
                                                                name="section_three_title"
                                                                value="{{ $homePage->section_three_title }}"
                                                                id="validationCustom01"
                                                    ...
                                                    <div class="col-lg-4">
                                                        <div class="fv-row mb-3">
                                                            ...
                                                            <input type="text"
                                                                class="form-control form-control-solid form-control-sm @error('section_three_button') is-invalid @enderror"
                                                                name="section_three_button"
                                                                value="{{ $homePage->section_three_button }}"
                                                                id="validationCustom01"
                                                    ...
                                                    <div class="col-lg-4">
                                                        <div class="fv-row mb-3">
                                                            <label class="form-label">Section Three First Column
                                                                Logo</label>
                                                            <input type="file"
                                                                class="form-control form-control-solid form-control-sm @error('section_three_first_column_logo') is-invalid @enderror"
                                                                name="section_three_first_column_logo"
                                                                value="{ $homePage->section_three_first_column_logo{  }}"id="validationCustom01"
                                                    ...
                                                    <div class="col-lg-4">
                                                        <div class="fv-row mb-3">
                                                            <label class="form-label">Section Three First Column
                                                                Title</label>
                                                            <input type="text"
                                                                class="form-control form-control-solid form-control-sm @error('section_three_first_column_title') is-invalid @enderror"
                                                                name="section_three_first_column_title"
                                                                value="{{ $homePage->section_three_first_column_title }}"
                                                                id="validationCustom01"
                                                    ...
                                                    <div class="col-lg-4">
                                                        <div class="fv-row mb-3">
                                                            <label class="form-label">Section Three Second Column
                                                                Logo</label>
                                                            <input type="file"
                                                                class="form-control form-control-solid form-control-sm @error('section_three_second_column_logo') is-invalid @enderror"
                                                                name="section_three_second_column_logo"
                                                                value="{{ $homePage->section_three_second_column_logo }}"
                                                                id="validationCustom01"
                                                                placeholder="Enter Section One Title">
                                                    ...
                                                    <div class="col-lg-4">
                                                        <div class="fv-row mb-3">
                                                            <label class="form-label">Section Three Second Column
                                                                Title</label>
                                                            <input type="text"
                                                                class="form-control form-control-solid form-control-sm @error('section_three_second_column_title') is-invalid @enderror"
                                                                name="section_three_second_column_title"
                                                                value="{{ $homePage->section_three_second_column_title }}"
                                                                id="validationCustom01"
                                                    ...
                                                    <div class="col-lg-4">
                                                        <div class="fv-row mb-3">
                                                            <label class="form-label">Section Three Third Column
                                                                Logo</label>
                                                            <input type="file"
                                                                class="form-control form-control-solid form-control-sm @error('section_three_third_column_logo') is-invalid @enderror"
                                                                name="section_three_third_column_logo"
                                                                value="{{ $homePage->section_three_third_column_logo }}"
                                                                id="validationCustom01"
                                                    ...
                                                    <div class="col-lg-4">
                                                        <div class="fv-row mb-3">
                                                            <label class="form-label">Section Three Third Column
                                                                Title</label>
                                                            <input type="text"
                                                                class="form-control form-control-solid form-control-sm @error('section_three_third_column_title') is-invalid @enderror"
                                                                name="section_three_third_column_title"
                                                                value="{{ $homePage->section_three_third_column_title }}"
                                                                id="validationCustom01"
                                                    ...
                                                    <div class="col-lg-4">
                                                        <div class="fv-row mb-3">
                                                            <label class="form-label">Section Three Fourth Column
                                                                Logo</label>
                                                            <input type="file"
                                                                class="form-control form-control-solid form-control-sm @error('section_three_fourth_column_logo') is-invalid @enderror"
                                                                name="section_three_fourth_column_logo"
                                                                value="{{ $homePage->section_three_fourth_column_logo }}"
                                                                id="validationCustom01"
                                                    ...
                                                    <div class="col-lg-4">
                                                        <div class="fv-row mb-3">
                                                            <label class="form-label">Section Three Fourth Column
                                                                Title</label>
                                                            <input type="text"
                                                                class="form-control form-control-solid form-control-sm @error('section_three_fourth_column_title') is-invalid @enderror"
                                                                name="section_three_fourth_column_title"
                                                                value="{{ $homePage->section_three_fourth_column_title }}"
                                                                id="validationCustom01"
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="fv-row mb-3">
                                                            ...
                                                            <select
                                                                ...
                                                                multiselect-max-items="4"
                                                                onchange="console.log(this.selectedOptions)">
                                                                @foreach (json_decode($newsTrends) as $newsTrend)
                                                                    <option value="{{ $newsTrend->id }}">
                                                                        {{ $newsTrend->title }}</option>
                                                                @endforeach
                                                            </select>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-4">
                                                        <div class="fv-row mb-3">
                                                            ...
                                                            <input type="text"
                                                                class="form-control form-control-solid form-control-sm @error('section_five_title') is-invalid @enderror"
                                                                name="section_five_title"
                                                                value="{{ $homePage->section_five_title }}"
                                                                id="validationCustom01"
                                                    ...
                                                    <div class="col-lg-4">
                                                        <div class="fv-row mb-3">
                                                            ...
                                                            <input type="text"
                                                                class="form-control form-control-solid form-control-sm @error('section_five_link_one_title') is-invalid @enderror"
                                                                name="section_five_link_one_title"
                                                                value="{{ $homePage->section_five_link_one_title }}"
                                                                id="validationCustom01"
                                                    ...
                                                    <div class="col-lg-4">
                                                        <div class="fv-row mb-3">
                                                            ...
                                                            <input type="text"
                                                                class="form-control form-control-solid form-control-sm @error('section_five_link_one_icon') is-invalid @enderror"
                                                                name="section_five_link_one_icon"
                                                                value="{{ $homePage->section_five_link_one_icon }}"
                                                                id="validationCustom01"
                                                    ...
                                                    <div class="col-lg-4">
                                                        <div class="fv-row mb-3">
                                                            ...
                                                            <input type="text"
                                                                class="form-control form-control-solid form-control-sm @error('section_five_link_one_link') is-invalid @enderror"
                                                                name="section_five_link_one_link"
                                                                value="{{ $homePage->section_five_link_one_link }}"
                                                                id="validationCustom01"
                                                    ...
                                                    <div class="col-lg-4">
                                                        <div class="fv-row mb-3">
                                                            ...
                                                            <input type="text"
                                                                class="form-control form-control-solid form-control-sm @error('section_five_link_two_title') is-invalid @enderror"
                                                                name="section_five_link_two_title"
                                                                value="{{ $homePage->section_five_link_two_title }}"
                                                                id="validationCustom01"
                                                    ...
                                                    <div class="col-lg-4">
                                                        <div class="fv-row mb-3">
                                                            ...
                                                            <input type="text"
                                                                ...
                                                                name="section_five_link_two_icon"
                                                                value="{{ $homePage->section_five_link_two_icon }}"
                                                                id="validationCustom01"
                                                    ...
                                                    <div class="col-lg-4">
                                                        <div class="fv-row mb-3">
                                                            ...
                                                            <input type="text"
                                                                class="form-control form-control-solid form-control-sm @error('section_five_link_two_link') is-invalid @enderror"
                                                                name="section_five_link_two_link"
                                                                value="{{ $homePage->section_five_link_two_link }}"
                                                                id="validationCustom01"
                                                    ...
                                                    <div class="col-lg-4">
                                                        <div class="fv-row mb-3">
                                                            ...
                                                            <input type="text"
                                                                class="form-control form-control-solid form-control-sm @error('section_five_link_three_title') is-invalid @enderror"
                                                                name="section_five_link_three_title"
                                                                value="{{ $homePage->section_five_link_three_title }}"
                                                                id="validationCustom01"
                                                    ...
                                                    <div class="col-lg-4">
                                                        <div class="fv-row mb-3">
                                                            ...
                                                            <input type="text"
                                                                class="form-control form-control-solid form-control-sm @error('section_five_link_three_icon') is-invalid @enderror"
                                                                name="section_five_link_three_icon"
                                                                value="{{ $homePage->section_five_link_three_icon }}"
                                                                id="validationCustom01"
                                                    ...
                                                    <div class="col-lg-4">
                                                        <div class="fv-row mb-3">
                                                            ...
                                                            <input type="text"
                                                                class="form-control form-control-solid form-control-sm @error('section_five_link_three_link') is-invalid @enderror"
                                                                name="section_five_link_three_link"
                                                                value="{{ $homePage->section_five_link_three_link }}"
                                                                id="validationCustom01"
                                                    ...
                                                    <div class="col-lg-4">
                                                        <div class="fv-row mb-3">
                                                            ...
                                                            <input type="text"
                                                                class="form-control form-control-solid form-control-sm @error('section_five_button_title') is-invalid @enderror"
                                                                name="section_five_button_title"
                                                                value="{{ $homePage->section_five_button_title }}"
                                                                id="validationCustom01"
                                                    ...
                                                    <div class="col-lg-4">
                                                        <div class="fv-row mb-3">
                                                            ...
                                                            <input type="text"
                                                                class="form-control form-control-solid form-control-sm @error('section_five_button_sub_title') is-invalid @enderror"
                                                                name="section_five_button_sub_title"
                                                                value="{{ $homePage->section_five_button_sub_title }}"
                                                                id="validationCustom01"
                                                    ...
                                                    <div class="col-lg-4">
                                                        <div class="fv-row mb-3">
                                                            ...
                                                            <input type="text"
                                                                class="form-control form-control-solid form-control-sm @error('section_five_button_link') is-invalid @enderror"
                                                                name="section_five_button_link"
                                                                value="{{ $homePage->section_five_button_link }}"
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-4">
                                                                <div class="fv-row mb-3">
                                                                    ...
                                                                    <input type="text"
                                                                        class="form-control form-control-solid form-control-sm @error('section_six_name') is-invalid @enderror"
                                                                        name="section_six_name"
                                                                        value="{{ $homePage->section_six_name }}"
                                                                        id="validationCustom01"
                                                            ...
                                                            <div class="col-lg-4">
                                                                <div class="fv-row mb-3">
                                                                    <label class="form-label">Section Six First Colum
                                                                        Image</label>
                                                                    <input type="file"
                                                                        class="form-control form-control-solid form-control-sm @error('section_six_first_column_image') is-invalid @enderror"
                                                                        name="section_six_first_column_image"
                                                                        value="{{ $homePage->section_six_first_column_image }}"
                                                                        id="validationCustom01"
                                                            ...
                                                            <div class="col-lg-4">
                                                                <div class="fv-row mb-3">
                                                                    <label class="form-label">Section Six First Column
                                                                        Title</label>
                                                                    <input type="text"
                                                                        class="form-control form-control-solid form-control-sm @error('section_six_first_column_title') is-invalid @enderror"
                                                                        name="section_six_first_column_title"
                                                                        value="{{ $homePage->section_six_first_column_title }}"
                                                                        id="validationCustom01"
                                                            ...
                                                            <div class="col-lg-4">
                                                                <div class="fv-row mb-3">
                                                                    <label class="form-label">Section Six First Colum
                                                                        ...
                                                                        Name</label>
                                                                    <input type="text"
                                                                        class="form-control form-control-solid form-control-sm @error('section_six_first_column_button_name') is-invalid @enderror"
                                                                        name="section_six_first_column_button_name"
                                                                        value="{{ $homePage->section_six_first_column_button_name }}"
                                                                        id="validationCustom01"
                                                            ...
                                                            <div class="col-lg-4">
                                                                <div class="fv-row mb-3">
                                                                    <label class="form-label">Section Six Fist Column
                                                                        Button
                                                                        Link</label>
