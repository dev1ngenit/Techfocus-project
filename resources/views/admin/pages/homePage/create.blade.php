                                                    ...
                                                    <div class="col-lg-4">
                                                        <div class="fv-row mb-3">
                                                            ...
                                                            <select
                                                                ...
                                                                name="country_id" id="field2" multiselect-search="true"
                                        ...
                                        <div class="w-100">
                                            ...
                                            <div class="fv-row">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-4">
                                                        <div class="fv-row mb-3">
                                                            <label class="form-label">Section Two Product</label>
                                                            <select
                                                    ...
                                                    <div class="col-lg-4">
                                                        <div class="fv-row mb-3">
                                                            ...
                                                            <input type="file"
                                                                ...
                                                                name="section_three_first_column_logo" id="validationCustom01"
