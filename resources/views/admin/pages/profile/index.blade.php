            ...
            <div id="kt_content_container" class="container-xxl">
                ...
                <div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
                    ...
                    <div class="card-body p-9">
                        <div class="row">
                            <div class="col-lg-6 col-12 border-0 border-right-2">
                                <!--begin::Row-->
                                <div class="row mb-7">
                                    <!--begin::Label-->
                            ...
                            <div class="col-lg-6 col-12 border-0 border-right-2">
                                ...
                                <div class="row mb-7">
                                    ...
                                    <!--begin::Col-->
                                    <div class="col-lg-8 fv-row">
                                        <span class="fw-bold text-gray-800 fs-6">{{ $profile->address }}</span>
                                    </div>
                                    <!--end::Col-->
                                </div>
                                <!--end::Input group-->
                                ...
                                <div class="row mb-7">
                                    ...
                                    <!--begin::Col-->
                                    <div class="col-lg-8">
                                        <span class="fw-bolder fs-6 text-gray-800">{{ $profile->designation }}</span>
                                    </div>
                                    <!--end::Col-->
                                </div>
                                <!--end::Row-->
                                ...
                                <div class="row mb-7">
                                    ...
                                    <div class="col-lg-8 fv-row">
                                        <span class="fw-bold text-gray-800 fs-6">
                                            @if (is_array(json_decode($profile->department)))
                                                @foreach (json_decode($profile->department) as $department)
                                                    <span class="badge bg-success">{{ ucfirst($department) }}</span>
                                                @endforeach
                                            @else
                                                <span class="badge bg-success">{{ ucfirst($profile->department) }}</span>
                                            @endif
                                        </span>
                                    </div>
                                    <!--end::Col-->
