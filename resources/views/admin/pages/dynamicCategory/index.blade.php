                                ...
                                <td>
                                    <div class="d-flex justify-content-between align-items-center">
                                        <a href="javascript:void()"
                                            ...
                                            data-kt-menu-placement="bottom-end" data-bs-toggle="modal"
                                            data-bs-target="#dynamicCategoryEdit">
...
{{-- Add Modal --}}
<div class="modal fade" id="dynamicCategoryEdit" data-backdrop="static">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content rounded-0 border-0 shadow-sm">
            <div class="modal-header p-2 rounded-0">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <label for="validationCustom04"
                                    class="form-label status @error ('status') is-invalid @enderror">Status</label>
                                <select class="form-select form-select-solid form-select-sm" name="country_id"
                                    data-dropdown-parent="#dynamicCategoryEdit" data-control="select2"
                                    data-placeholder="Select an option" data-allow-clear="true">
                                    <option></option>
                                    <option value="1">Active</option>
                                    <option value="2">Inactive</option>
