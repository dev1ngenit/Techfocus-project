...
>>>>>>> 52dc0163bc4d78580dc42ce3fc8ddcf0d592f32e
                    <div class="container px-0">
                        <div class="row">
                            <div class="col-lg-4 col-sm-12 text-lg-start text-sm-center">
                                <div class="d-flex align-items-center position-relative my-1">
                            ...
                            <div class="col-lg-4 col-sm-12 text-lg-end text-sm-center">
                                ...
                                <a href="{{ route('admin.solution-details.create') }}" type="button" class="btn btn-sm btn-light-success p-4 rounded-0">
                                    Add New
                                </a>
                ...
                <div class="card-body">
                    <table
                        class="table table-striped table-hover align-middle rounded-0 border fs-6 g-5"
                        id="kt_datatable_example_1">
                        <thead class="table_header_bg">
                            <tr class="text-center text-gray-900 fw-bolder fs-7 text-uppercase">
                                <th class="" width="5%">Sl</th>
