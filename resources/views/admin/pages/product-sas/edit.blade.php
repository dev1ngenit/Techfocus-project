        ...
        <div class="row">
            <div class="col-lg-12 card rounded-0 shadow-sm p-0">
                <div class="card card-p-0 card-flush">
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.product-sas.update', $ProductSas->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="row gx-1">
                                <div class="col-lg-4">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="d-flex justify-content-between align-items-center">
                                                    ...
                                                    <input type="text"
                                                        ...
                                                        name="cog_price" value="{{ $ProductSas->cog_price }}"
                                                    ...
                                                    <td class="p-1">
                                                        <div>
                                                            <input type="text"
                                                                ...
                                                                name="bank_charge" value="{{ $ProductSas->bank_charge }}"
                                                                id="validationCustom01" placeholder="E.g: 0.05%, 0.5%, 5%">
                                                        </div>
                                                    </td>
                                                    <td class="p-1">
                                                    ...
                                                    <td class="p-1">
                                                        <div>
                                                            <input type="text"
                                                                ...
                                                                name="customs" value="{{ $ProductSas->customs }}"
                                                    ...
                                                    <td class="p-1">
                                                        <div>
                                                            <input type="text"
                                                                ...
                                                                value="{{ $ProductSas->sales_comission }}"
                                                                id="validationCustom01"
                                                                placeholder="E.g: 0.05%, 0.5%, 5%">
                                                        </div>
                                                    </td>
                                                    ...
                                                    <td class="p-1">
                                                        <div>
                                                            <input type="text"
                                                                ...
                                                                name="liability" value="{{ $ProductSas->liability }}"
                                                                id="validationCustom01"
                                                                placeholder="E.g: 0.05%, 0.5%, 5%">
                                                        </div>
                                                    </td>
                                                    ...
                                                    <td class="p-1">
                                                        <div>
                                                            <input type="text"
                                                                ...
                                                                name="capital_share"
                                                                value="{{ $ProductSas->capital_share }}"
                                                                id="validationCustom01"
                                                                placeholder="E.g: 0.05%, 0.5%, 5%">
                                                        </div>
                                                    </td>
                                                    ...
                                                    <td class="p-1">
                                                        <div>
                                                            <input type="text"
                                                                ...
                                                                value="{{ $ProductSas->management_cost }}"
                                                                id="validationCustom01"
                                                                placeholder="E.g: 0.05%, 0.5%, 5%">
                                                        </div>
                                                    </td>
                                                    ...
                                                    <td class="p-1">
                                                        <div>
                                                            <input type="text"
                                                                ...
                                                                value="{{ $ProductSas->regular_discounts }}"
                                                                id="validationCustom01"
                                                                placeholder="E.g: 0.05%, 0.5%, 5%">
                                                        </div>
                                                    </td>
                                                    ...
                                                    <td class="p-1">
                                                        <div>
                                                            <input type="text"
                                                                ...
                                                                name="rebates" value="{{ $ProductSas->rebates }}"
                                                                id="validationCustom01"
                                                                placeholder="E.g: 0.05%, 0.5%, 5%">
                                                        </div>
                                                    </td>
