                                                    ...
                                                    <div class="col-lg-3">
                                                        <div class="fv-row mb-3">
                                                            ...
                                                            <input type="text"
                                                                ...
                                                                value="{{ old('section_two_badge') }}" maxlength="220"
                                                    ...
                                                    <div class="col-lg-3">
                                                        <div class="fv-row mb-3">
                                                            ...
                                                            <input type="text"
                                                                ...
                                                                value="{{ old('section_two_title_1') }}" maxlength="220"
                                                                id="validationCustom01"
                                                                placeholder="Enter Section Two Badge">
                                                    ...
                                                    <div class="col-lg-3">
                                                        <div class="fv-row mb-3">
                                                            ...
                                                            <input type="text"
                                                                ...
                                                                value="{{ old('section_two_title_span') }}"
                                                    ...
                                                    <div class="col-lg-3">
                                                        <div class="fv-row mb-3">
                                                            ...
                                                            <input type="text"
                                                                ...
                                                                value="{{ old('section_two_subtitle') }}" maxlength="220"
                                                                id="validationCustom01"
                                                    ...
                                                    <div class="col-lg-3">
                                                        <div class="fv-row mb-3">
                                                            ...
                                                            <input type="file"
                                                                ...
                                                                value="{{ old('section_two_main_image') }}"
                                                                id="validationCustom01"
                                                    ...
                                                    <div class="col-lg-3">
                                                        <div class="fv-row mb-3">
                                                            ...
                                                            <input type="file"
                                                                ...
                                                                value="{{ old('section_two_secondary_image') }}"
                                                                id="validationCustom01"
                                                    ...
                                                    <div class="col-lg-3">
                                                        <div class="fv-row mb-3">
                                                            ...
                                                            <input type="text"
                                                                ...
                                                                value="{{ old('section_two_secondary_image_count') }}"
                                                                id="validationCustom01"
                                                    ...
                                                    <div class="col-lg-3">
                                                        <div class="fv-row mb-3">
                                                            ...
                                                            <input type="text"
                                                                ...
                                                                value="{{ old('section_two_secondary_image_title') }}"
                                                                maxlength="220" id="validationCustom01"
                                                    ...
                                                    <div class="col-lg-3">
                                                        <div class="fv-row mb-3">
                                                            ...
                                                            <input type="text"
                                                                ...
                                                                value="{{ old('section_two_button_name') }}"
                                                                maxlength="220" id="validationCustom01"
                                                    ...
                                                    <div class="col-lg-3">
                                                        <div class="fv-row mb-3">
                                                            ...
                                                            <input type="url"
                                                                ...
                                                                value="{{ old('section_two_button_link') }}"
                                                                id="validationCustom01"
                                                    ...
                                                    <div class="col-lg-9">
                                                        <div class="fv-row mb-3">
                                                            ...
                                                            <textarea rows="1" name="section_two_description"
                                                                ...
                                                                placeholder="Enter Section Two Description">{{ old('section_two_description') }}</textarea>
                                                                    ...
                                                                    <div class="col-lg-6">
                                                                        <div class="fv-row mb-3">
                                                                            ...
                                                                            <input type="text"
                                                                                ...
                                                                                value="{{ old('section_three_tab_one_title') }}"
                                                                    ...
                                                                    <div class="col-lg-6">
                                                                        <div class="fv-row mb-3">
                                                                            ...
                                                                            <textarea rows="1" name="section_three_tab_one_short_description"
                                                                                ...
                                                                                placeholder="Enter Section Three Tab One Short Description">{{ old('section_three_tab_one_short_description') }}</textarea>
                                                                    ...
                                                                    <div class="col-lg-3">
                                                                        <div class="fv-row mb-3">
                                                                            ...
                                                                            <input type="text" maxlength="220"
                                                                                ...
                                                                                value="{{ old('section_three_tab_one_list_title') }}"
                                                                                id="validationCustom01"
                                                                    ...
                                                                    <div class="col-lg-3">
                                                                        <div class="fv-row mb-3">
                                                                            ...
                                                                            <input type="text" maxlength="220"
                                                                                ...
                                                                                value="{{ old('section_three_tab_one_list_1') }}"
                                                                                id="validationCustom01"
                                                                    ...
                                                                    <div class="col-lg-3">
                                                                        <div class="fv-row mb-3">
                                                                            ...
                                                                            <input type="text" maxlength="220"
                                                                                ...
                                                                                value="{{ old('section_three_tab_one_list_2') }}"
                                                                                id="validationCustom01"
                                                                    ...
                                                                    <div class="col-lg-3">
                                                                        <div class="fv-row mb-3">
                                                                            ...
                                                                            <input type="text" maxlength="220"
                                                                                ...
                                                                                value="{{ old('section_three_tab_one_list_3') }}"
                                                                                id="validationCustom01"
                                                                    ...
                                                                    <div class="col-lg-3">
                                                                        <div class="fv-row mb-3">
                                                                            ...
                                                                            <input type="text" maxlength="220"
                                                                                ...
                                                                                value="{{ old('section_three_tab_one_list_4') }}"
                                                                                id="validationCustom01"
                                                                    ...
                                                                    <div class="col-lg-3">
                                                                        <div class="fv-row mb-3">
                                                                            ...
                                                                            <input type="text" maxlength="220"
                                                                                ...
                                                                                value="{{ old('section_three_tab_one_quote') }}"
                                                                    ...
                                                                    <div class="col-lg-3">
                                                                        <div class="fv-row mb-3">
                                                                            ...
                                                                            <input type="text" maxlength="220"
                                                                                ...
                                                                                value="{{ old('section_three_tab_one_quote_author') }}"
                                                                                id="validationCustom01"
                                                                    ...
                                                                    <div class="col-lg-3">
                                                                        <div class="fv-row mb-3">
                                                                            ...
                                                                            <input type="text" maxlength="220"
                                                                                ...
                                                                                value="{{ old('section_three_tab_one_button_name') }}"
                                                                                id="validationCustom01"
                                                                    ...
                                                                    <div class="col-lg-6">
                                                                        <div class="fv-row mb-3">
                                                                            ...
                                                                            <input type="url"
                                                                                ...
                                                                                value="{{ old('section_three_tab_one_button_link') }}"
                                                                                id="validationCustom01"
                                                                    ...
                                                                    <div class="col-lg-6">
                                                                        <div class="fv-row mb-3">
                                                                            ...
                                                                            <textarea rows="1" name="section_three_tab_one_detailed_description"
                                                                                ...
                                                                                placeholder="Enter Section Three Tab One Detailed Description">{{ old('section_three_tab_one_detailed_description') }}</textarea>
                                                                    ...
                                                                    <div class="col-lg-6">
                                                                        <div class="fv-row mb-3">
                                                                            ...
                                                                            <input type="text" maxlength="220"
                                                                                ...
                                                                                value="{{ old('section_three_tab_two_title') }}"
                                                                                id="validationCustom01"
                                                                    ...
                                                                    <div class="col-lg-6">
                                                                        <div class="fv-row mb-3">
                                                                            ...
                                                                            <textarea rows="1" name="section_three_tab_two_short_description"
                                                                                ...
                                                                                placeholder="Enter Section Three Tab two Short Description">{{ old('section_three_tab_two_short_description') }}</textarea>
                                                                    ...
                                                                    <div class="col-lg-3">
                                                                        <div class="fv-row mb-3">
                                                                            ...
                                                                            <input type="text" maxlength="220"
                                                                                ...
                                                                                value="{{ old('section_three_tab_two_list_title') }}"
                                                                                id="validationCustom01"
                                                                    ...
                                                                    <div class="col-lg-3">
                                                                        <div class="fv-row mb-3">
                                                                            ...
                                                                            <input type="text" maxlength="220"
                                                                                ...
                                                                                value="{{ old('section_three_tab_two_list_1') }}"
                                                                                id="validationCustom01"
                                                                    ...
                                                                    <div class="col-lg-3">
                                                                        <div class="fv-row mb-3">
                                                                            ...
                                                                            <input type="text" maxlength="220"
                                                                                ...
                                                                                value="{{ old('section_three_tab_two_list_2') }}"
                                                                                id="validationCustom01"
                                                                                placeholder="Enter Section Three Tab two List Two">
                                                                    ...
                                                                    <div class="col-lg-3">
                                                                        <div class="fv-row mb-3">
                                                                            ...
                                                                            <input type="text" maxlength="220"
                                                                                ...
                                                                                value="{{ old('section_three_tab_two_list_3') }}"
                                                                                id="validationCustom01"
                                                                    ...
                                                                    <div class="col-lg-3">
                                                                        <div class="fv-row mb-3">
                                                                            ...
                                                                            <input type="text" maxlength="220"
                                                                                ...
                                                                                value="{{ old('section_three_tab_two_list_4') }}"
                                                                                id="validationCustom01"
                                                                    ...
                                                                    <div class="col-lg-3">
                                                                        <div class="fv-row mb-3">
                                                                            ...
                                                                            <input type="text" maxlength="220"
                                                                                ...
                                                                                value="{{ old('section_three_tab_two_quote') }}"
                                                                                maxlength="250" id="validationCustom01"
                                                                    ...
                                                                    <div class="col-lg-3">
                                                                        <div class="fv-row mb-3">
                                                                            ...
                                                                            <input type="text" maxlength="220"
                                                                                ...
                                                                                value="{{ old('section_three_tab_two_quote_author') }}"
                                                                                id="validationCustom01"
                                                                    ...
                                                                    <div class="col-lg-3">
                                                                        <div class="fv-row mb-3">
                                                                            ...
                                                                            <input type="text" maxlength="220"
                                                                                ...
                                                                                value="{{ old('section_three_tab_two_button_name') }}"
                                                                                id="validationCustom01"
                                                                    ...
                                                                    <div class="col-lg-6">
                                                                        <div class="fv-row mb-3">
                                                                            ...
                                                                            <input type="url"
                                                                                ...
                                                                                value="{{ old('section_three_tab_two_button_link') }}"
                                                                                id="validationCustom01"
                                                                    ...
                                                                    <div class="col-lg-6">
                                                                        <div class="fv-row mb-3">
                                                                            ...
                                                                            <textarea rows="1" name="section_three_tab_two_detailed_description"
                                                                                ...
                                                                                placeholder="Enter Section Three Tab two Detailed Description">{{ old('section_three_tab_two_detailed_description') }}</textarea>
                                                                    ...
                                                                    <div class="col-lg-6">
                                                                        <div class="fv-row mb-3">
                                                                            ...
                                                                            <input type="text" maxlength="220"
                                                                                ...
                                                                                value="{{ old('section_three_tab_three_title') }}"
                                                                                id="validationCustom01"
                                                                    ...
                                                                    <div class="col-lg-6">
                                                                        <div class="fv-row mb-3">
                                                                            ...
                                                                            <textarea rows="1" name="section_three_tab_three_short_description"
                                                                                ...
                                                                                placeholder="Enter Section Three Tab three Short Description">{{ old('section_three_tab_three_short_description') }}</textarea>
                                                                    ...
                                                                    <div class="col-lg-3">
                                                                        <div class="fv-row mb-3">
                                                                            ...
                                                                            <input type="text" maxlength="220"
                                                                                ...
                                                                                value="{{ old('section_three_tab_three_list_title') }}"
                                                                                id="validationCustom01"
                                                                    ...
                                                                    <div class="col-lg-3">
                                                                        <div class="fv-row mb-3">
                                                                            ...
                                                                            <input type="text" maxlength="220"
                                                                                ...
                                                                                value="{{ old('section_three_tab_three_list_1') }}"
                                                                                id="validationCustom01"
                                                                    ...
                                                                    <div class="col-lg-3">
                                                                        <div class="fv-row mb-3">
                                                                            ...
                                                                            <input type="text" maxlength="220"
                                                                                ...
                                                                                value="{{ old('section_three_tab_three_list_2') }}"
                                                                                id="validationCustom01"
                                                                                placeholder="Enter Section Three Tab three List three">
                                                                    ...
                                                                    <div class="col-lg-3">
                                                                        <div class="fv-row mb-3">
                                                                            ...
                                                                            <input type="text"
                                                                                ...
                                                                                value="{{ old('section_three_tab_three_list_3') }}"
                                                                                id="validationCustom01" maxlength="220"
                                                                                placeholder="Enter Section Three Tab three List Three">
                                                                    ...
                                                                    <div class="col-lg-3">
                                                                        <div class="fv-row mb-3">
                                                                            ...
                                                                            <input type="text"
                                                                                ...
                                                                                value="{{ old('section_three_tab_three_list_4') }}"
                                                                                id="validationCustom01" maxlength="220"
                                                                    ...
                                                                    <div class="col-lg-3">
                                                                        <div class="fv-row mb-3">
                                                                            ...
                                                                            <input type="text"
                                                                                ...
                                                                                value="{{ old('section_three_tab_three_quote') }}"
                                                                                id="validationCustom01"
                                                                    ...
                                                                    <div class="col-lg-3">
                                                                        <div class="fv-row mb-3">
                                                                            ...
                                                                            <input type="text"
                                                                                ...
                                                                                value="{{ old('section_three_tab_three_quote_author') }}"
                                                                                id="validationCustom01" maxlength="220"
                                                                    ...
                                                                    <div class="col-lg-3">
                                                                        <div class="fv-row mb-3">
                                                                            ...
                                                                            <input type="text"
                                                                                ...
                                                                                value="{{ old('section_three_tab_three_button_name') }}"
                                                                                id="validationCustom01" maxlength="220"
                                                                    ...
                                                                    <div class="col-lg-6">
                                                                        <div class="fv-row mb-3">
                                                                            ...
                                                                            <input type="url"
                                                                                ...
                                                                                value="{{ old('section_three_tab_three_button_link') }}"
                                                                                id="validationCustom01"
                                                                    ...
                                                                    <div class="col-lg-6">
                                                                        <div class="fv-row mb-3">
                                                                            ...
                                                                            <textarea rows="1" name="section_three_tab_three_detailed_description"
                                                                                ...
                                                                                placeholder="Enter Section Three Tab three Detailed Description">{{ old('section_three_tab_three_detailed_description') }}</textarea>
                                                                    ...
                                                                    <div class="col-lg-6">
                                                                        <div class="fv-row mb-3">
                                                                            ...
                                                                            <input type="text" maxlength="220"
                                                                                ...
                                                                                value="{{ old('section_three_tab_four_title') }}"
                                                                                id="validationCustom01"
                                                                                placeholder="Enter Section Three Tab Three Title">
                                                                    ...
                                                                    <div class="col-lg-6">
                                                                        <div class="fv-row mb-3">
                                                                            ...
                                                                            <textarea rows="1" name="section_three_tab_four_short_description"
                                                                                ...
                                                                                placeholder="Enter Section Three Tab Four Short Description">{{ old('section_three_tab_four_short_description') }}</textarea>
                                                                    ...
                                                                    <div class="col-lg-3">
                                                                        <div class="fv-row mb-3">
                                                                            ...
                                                                            <input type="text" maxlength="220"
                                                                                ...
                                                                                value="{{ old('section_three_tab_four_list_title') }}"
                                                                                id="validationCustom01"
                                                                    ...
                                                                    <div class="col-lg-3">
                                                                        <div class="fv-row mb-3">
                                                                            ...
                                                                            <input type="text" maxlength="220"
                                                                                ...
                                                                                value="{{ old('section_three_tab_four_list_1') }}"
                                                                                id="validationCustom01"
                                                                    ...
                                                                    <div class="col-lg-3">
                                                                        <div class="fv-row mb-3">
                                                                            ...
                                                                            <input type="text" maxlength="220"
                                                                                ...
                                                                                value="{{ old('section_three_tab_four_list_2') }}"
                                                                                id="validationCustom01"
                                                                                placeholder="Enter Section Three Tab four List four">
                                                                    ...
                                                                    <div class="col-lg-3">
                                                                        <div class="fv-row mb-3">
                                                                            ...
                                                                            <input type="text" maxlength="220"
                                                                                ...
                                                                                value="{{ old('section_three_tab_four_list_3') }}"
                                                                                id="validationCustom01"
                                                                                placeholder="Enter Section Three Tab four List four">
                                                                    ...
                                                                    <div class="col-lg-3">
                                                                        <div class="fv-row mb-3">
                                                                            ...
                                                                            <input type="text" maxlength="220"
                                                                                ...
                                                                                value="{{ old('section_three_tab_four_list_4') }}"
                                                                                id="validationCustom01"
                                                                                placeholder="Enter Section Three Tab four List Four">
                                                                    ...
                                                                    <div class="col-lg-3">
                                                                        <div class="fv-row mb-3">
                                                                            ...
                                                                            <input type="text" maxlength="220"
                                                                                ...
                                                                                value="{{ old('section_three_tab_four_quote') }}"
                                                                                id="validationCustom01"
                                                                    ...
                                                                    <div class="col-lg-3">
                                                                        <div class="fv-row mb-3">
                                                                            ...
                                                                            <input type="text" maxlength="220"
                                                                                ...
                                                                                value="{{ old('section_three_tab_four_quote_author') }}"
                                                                                id="validationCustom01"
                                                                    ...
                                                                    <div class="col-lg-3">
                                                                        <div class="fv-row mb-3">
                                                                            ...
                                                                            <input type="text" maxlength="220"
                                                                                ...
                                                                                value="{{ old('section_three_tab_four_button_name') }}"
                                                                                id="validationCustom01"
                                                                    ...
                                                                    <div class="col-lg-6">
                                                                        <div class="fv-row mb-3">
                                                                            ...
                                                                            <input type="url"
                                                                                ...
                                                                                value="{{ old('section_three_tab_four_button_link') }}"
                                                                                id="validationCustom01"
                                                                    ...
                                                                    <div class="col-lg-6">
                                                                        <div class="fv-row mb-3">
                                                                            ...
                                                                            <textarea rows="1" name="section_three_tab_four_detailed_description"
                                                                                ...
                                                                                placeholder="Enter Section Three Tab four Detailed Description">{{ old('section_three_tab_four_detailed_description') }}</textarea>
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="fv-row mb-3">
                                                            ...
                                                            <input type="file"
                                                                ...
                                                                value="{{ old('section_four_banner_middle_image') }}"
                                                                id="validationCustom01"
                                                            ...
                                                            <div class="col-lg-3">
                                                                <div class="fv-row mb-3">
                                                                    ...
                                                                    <input type="text" maxlength="220"
                                                                        ...
                                                                        value="{{ old('section_five_col_one_title') }}"
                                                                        id="validationCustom01"
                                                            ...
                                                            <div class="col-lg-3">
                                                                <div class="fv-row mb-3">
                                                                    ...
                                                                    <input type="file"
                                                                        ...
                                                                        value="{{ old('section_five_ceo_sign') }}"
                                                                        id="validationCustom01"
                                                            ...
                                                            <div class="col-lg-3">
                                                                <div class="fv-row mb-3">
                                                                    ...
                                                                    <input type="text" maxlength="220"
                                                                        ...
                                                                        value="{{ old('section_five_ceo_name') }}"
                                                                        id="validationCustom01"
                                                            ...
                                                            <div class="col-lg-3">
                                                                <div class="fv-row mb-3">
                                                                    ...
                                                                    <input type="text" maxlength="220"
                                                                        ...
                                                                        value="{{ old('section_five_ceo_designation') }}"
                                                                        id="validationCustom01"
                                                            ...
                                                            <div class="col-lg-4">
                                                                <div class="fv-row mb-3">
                                                                    ...
                                                                    <input type="url"
                                                                        ...
                                                                        value="{{ old('section_five_ceo_facebook_account_link') }}"
                                                                        id="validationCustom01"
                                                            ...
                                                            <div class="col-lg-4">
                                                                <div class="fv-row mb-3">
                                                                    ...
                                                                    <input type="url"
                                                                        ...
                                                                        value="{{ old('section_five_ceo_twitter_account_link') }}"
                                                                        id="validationCustom01"
                                                            ...
                                                            <div class="col-lg-4">
                                                                <div class="fv-row mb-3">
                                                                    ...
                                                                    <input type="url"
                                                                        ...
                                                                        value="{{ old('section_five_ceo_whatsapp_account_link') }}"
                                                                        id="validationCustom01"
                                                            ...
                                                            <div class="col-lg-12">
                                                                <div class="fv-row mb-3">
                                                                    ...
                                                                    <textarea rows="1" name="section_five_col_one_description"
                                                                        ...
                                                                        placeholder="Enter Section Five Col One Description">{{ old('section_five_col_one_description') }}</textarea>
                                                            ...
                                                            <div class="col-lg-3">
                                                                <div class="fv-row mb-3">
                                                                    ...
                                                                    <input type="text" maxlength="220"
                                                                        ...
                                                                        value="{{ old('section_five_col_two_title') }}"
                                                                        id="validationCustom01"
                                                                        placeholder="Enter Section Five Col One Title">
                                                            ...
                                                            <div class="col-lg-3">
                                                                <div class="fv-row mb-3">
                                                                    ...
                                                                    <input type="text" maxlength="220"
                                                                        ...
                                                                        value="{{ old('section_five_col_two_list_1') }}"
                                                                        id="validationCustom01"
                                                                        placeholder="Enter Section Five Col One Title">
                                                            ...
                                                            <div class="col-lg-3">
                                                                <div class="fv-row mb-3">
                                                                    ...
                                                                    <input type="text" maxlength="220"
                                                                        ...
                                                                        value="{{ old('section_five_col_two_list_2') }}"
                                                                        id="validationCustom01"
                                                                        placeholder="Enter Section Five Col One Title">
                                                            ...
                                                            <div class="col-lg-3">
                                                                <div class="fv-row mb-3">
                                                                    ...
                                                                    <input type="text" maxlength="220"
                                                                        ...
                                                                        value="{{ old('section_five_col_two_list_3') }}"
                                                                        id="validationCustom01"
                                                                        placeholder="Enter Section Five Col One Title">
                                                            ...
                                                            <div class="col-lg-3">
                                                                <div class="fv-row mb-3">
                                                                    ...
                                                                    <input type="text" maxlength="220"
                                                                        ...
                                                                        value="{{ old('section_five_col_two_list_4') }}"
                                                                        id="validationCustom01"
                                                                        placeholder="Enter Section Five Col One Title">
                                                            ...
                                                            <div class="col-lg-9">
                                                                <div class="fv-row mb-3">
                                                                    ...
                                                                    @error('section_five_col_two_content') is-invalid @enderror"
                                                                        placeholder="Enter Section Five Col Two Content">{{ old('section_five_col_two_content') }}</textarea>
                                                                    ...
                                                                    <div class="col-lg-4">
                                                                        <div class="fv-row mb-3">
                                                                            ...
                                                                            <input type="text" maxlength="220"
                                                                                ...
                                                                                value="{{ old('section_six_card_one_title') }}"
                                                                                id="validationCustom01"
                                                                    ...
                                                                    <div class="col-lg-4">
                                                                        <div class="fv-row mb-3">
                                                                            ...
                                                                            <input type="text" maxlength="220"
                                                                                ...
                                                                                value="{{ old('section_six_card_one_count') }}"
                                                                                id="validationCustom01"
                                                                    ...
                                                                    <div class="col-lg-4">
                                                                        <div class="fv-row mb-3">
                                                                            ...
                                                                            <input type="text" maxlength="220"
                                                                                ...
                                                                                value="{{ old('section_six_card_one_icon') }}"
                                                                                id="validationCustom01"
                                                                    ...
                                                                    <div class="col-lg-12">
                                                                        <div class="fv-row mb-3">
                                                                            ...
                                                                            <textarea rows="1" name="section_six_card_one_short_description"
                                                                                ...
                                                                                placeholder="Enter Section Six Card One Short Description">{{ old('section_six_card_one_short_description') }}</textarea>
                                                                    ...
                                                                    <div class="col-lg-4">
                                                                        <div class="fv-row mb-3">
                                                                            ...
                                                                            <input type="text" maxlength="220"
                                                                                ...
                                                                                value="{{ old('section_six_card_two_title') }}"
                                                                                id="validationCustom01"
                                                                    ...
                                                                    <div class="col-lg-4">
                                                                        <div class="fv-row mb-3">
                                                                            ...
                                                                            <input type="text" maxlength="220"
                                                                                ...
                                                                                value="{{ old('section_six_card_two_count') }}"
                                                                                id="validationCustom01"
                                                                    ...
                                                                    <div class="col-lg-4">
                                                                        <div class="fv-row mb-3">
                                                                            ...
                                                                            <input type="text" maxlength="220"
                                                                                ...
                                                                                value="{{ old('section_six_card_two_icon') }}"
                                                                                id="validationCustom01"
                                                                    ...
                                                                    <div class="col-lg-12">
                                                                        <div class="fv-row mb-3">
                                                                            ...
                                                                            <textarea rows="1" name="section_six_card_two_short_description"
                                                                                ...
                                                                                placeholder="Enter Section Six Card two Short Description">{{ old('section_six_card_two_short_description') }}</textarea>
                                                                    ...
                                                                    <div class="col-lg-4">
                                                                        <div class="fv-row mb-3">
                                                                            ...
                                                                            <input type="text" maxlength="220"
                                                                                ...
                                                                                value="{{ old('section_six_card_three_title') }}"
                                                                                id="validationCustom01"
                                                                    ...
                                                                    <div class="col-lg-4">
                                                                        <div class="fv-row mb-3">
                                                                            ...
                                                                            <input type="text" maxlength="220"
                                                                                ...
                                                                                value="{{ old('section_six_card_three_count') }}"
                                                                                id="validationCustom01"
                                                                    ...
                                                                    <div class="col-lg-4">
                                                                        <div class="fv-row mb-3">
                                                                            ...
                                                                            <input type="text" maxlength="220"
                                                                                ...
                                                                                value="{{ old('section_six_card_three_icon') }}"
                                                                                id="validationCustom01"
                                                                    ...
                                                                    <div class="col-lg-12">
                                                                        <div class="fv-row mb-3">
                                                                            ...
                                                                            <textarea rows="1" name="section_six_card_three_short_description"
                                                                                ...
                                                                                placeholder="Enter Section Six Card Three Short Description">{{ old('section_six_card_three_short_description') }}</textarea>
                                                                    ...
                                                                    <div class="col-lg-4">
                                                                        <div class="fv-row mb-3">
                                                                            ...
                                                                            <input type="text" maxlength="220"
                                                                                ...
                                                                                value="{{ old('section_six_card_four_title') }}"
                                                                                id="validationCustom01"
                                                                    ...
                                                                    <div class="col-lg-4">
                                                                        <div class="fv-row mb-3">
                                                                            ...
                                                                            <input type="text" maxlength="220"
                                                                                ...
                                                                                value="{{ old('section_six_card_four_count') }}"
                                                                                id="validationCustom01"
                                                                    ...
                                                                    <div class="col-lg-4">
                                                                        <div class="fv-row mb-3">
                                                                            ...
                                                                            <input type="text" maxlength="220"
                                                                                ...
                                                                                value="{{ old('section_six_card_four_icon') }}"
                                                                                id="validationCustom01"
                                                                    ...
                                                                    <div class="col-lg-12">
                                                                        <div class="fv-row mb-3">
                                                                            ...
                                                                            <textarea rows="1" name="section_six_card_four_short_description"
                                                                                ...
                                                                                placeholder="Enter Section Six Card Four Short Description">{{ old('section_six_card_four_short_description') }}</textarea>
                                                            ...
                                                            <select
                                                                ...
                                                                @foreach ($brands as $brand)
                                                                    <option value="{{ $brand->id }}"
                                                                        {{ is_array(old('brand_id')) && in_array($brand->id, old('brand_id')) ? ' selected' : '' }}>
                                                                        {{ $brand->title }}
                                                                    </option>
                                                                @endforeach
                                                            </select>
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <select
                                                            ...
                                                            <option value="inactive"
                                                                {{ old('status') == 'inactive' ? 'selected' : '' }}>In
                                                                Active</option>
                                                        </select>
                                                        @error('status')
                                                            <div class="invalid-feedback d-block">{{ $message }}</div>
