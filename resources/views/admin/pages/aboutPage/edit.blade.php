            ...
            <div class="card">
                <div class="main_bg card-header py-2 main_bg align-items-center">
                    ...
                    <div class="col-lg-7 col-sm-12 d-flex justify-content-end">
                        <h4 class="text-white p-0 m-0 fw-bold">About Us Edit Page</h4>
                    </div>
                </div>
                                                    ...
                                                    <div class="col-lg-3">
                                                        <div class="fv-row mb-3">
                                                            ...
                                                            <input type="text"
                                                                ...
                                                                name="section_two_badge"
                                                                value="{{ $aboutPage->section_two_badge }}" maxlength="220"
                                                    ...
                                                    <div class="col-lg-3">
                                                        <div class="fv-row mb-3">
                                                            ...
                                                            <input type="text"
                                                                ...
                                                                name="section_two_title_1"
                                                                value="{{ $aboutPage->section_two_title_1 }}"
                                                                maxlength="220" id="validationCustom01"
                                                                placeholder="Enter Section Two Badge">
                                                    ...
                                                    <div class="col-lg-3">
                                                        <div class="fv-row mb-3">
                                                            ...
                                                            <input type="text"
                                                                ...
                                                                name="section_two_title_span"
                                                                value="{{ $aboutPage->section_two_title_span }}"
                                                                maxlength="220" id="validationCustom01"
                                                    ...
                                                    <div class="col-lg-3">
                                                        <div class="fv-row mb-3">
                                                            ...
                                                            <input type="text"
                                                                ...
                                                                value="{{ $aboutPage->section_two_subtitle }}"
                                                                maxlength="220" id="validationCustom01"
                                                    ...
                                                    <div class="col-lg-3">
                                                        <div class="fv-row mb-3">
                                                            ...
                                                            <input type="file"
                                                                ...
                                                                name="section_two_main_image"
                                                                value="{{ $aboutPage->section_two_main_image }}"
                                                                id="validationCustom01"
                                                    ...
                                                    <div class="col-lg-3">
                                                        <div class="fv-row mb-3">
                                                            ...
                                                            <input type="file"
                                                                ...
                                                                name="section_two_secondary_image"
                                                                value="{{ $aboutPage->section_two_secondary_image }}"
                                                                id="validationCustom01"
                                                    ...
                                                    <div class="col-lg-3">
                                                        <div class="fv-row mb-3">
                                                            ...
                                                            <input type="text"
                                                                ...
                                                                value="{{ $aboutPage->section_two_secondary_image_count }}"
                                                                id="validationCustom01"
                                                    ...
                                                    <div class="col-lg-3">
                                                        <div class="fv-row mb-3">
                                                            ...
                                                            <input type="text"
                                                                ...
                                                                value="{{ $aboutPage->section_two_secondary_image_title }}"
                                                                maxlength="220" id="validationCustom01"
                                                    ...
                                                    <div class="col-lg-3">
                                                        <div class="fv-row mb-3">
                                                            ...
                                                            <input type="text"
                                                                ...
                                                                name="section_two_button_name"
                                                                value="{{ $aboutPage->section_two_button_name }}"
                                                                maxlength="220" id="validationCustom01"
                                                    ...
                                                    <div class="col-lg-3">
                                                        <div class="fv-row mb-3">
                                                            ...
                                                            <input type="url"
                                                                ...
                                                                name="section_two_button_link"
                                                                value="{{ $aboutPage->section_two_button_link }}"
                                                                id="validationCustom01"
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-lg-6">
                                                                        <div class="fv-row mb-3">
                                                                            ...
                                                                            <input type="text"
                                                                                ...
                                                                                value="{{ $aboutPage->section_three_tab_one_title }}"
                                                                    ...
                                                                    <div class="col-lg-6">
                                                                        <div class="fv-row mb-3">
                                                                            <label class="form-label">Section Three Tab One
                                                                                Short
                                                                                Description</label>
                                                                            <textarea rows="1" name="section_three_tab_one_short_description"
                                                                                class="form-control form-control-sm form-control-solid @error('section_three_tab_one_short_description') is-invalid @enderror"
                                                                                placeholder="Enter Section Three Tab One Short Description">{{ $aboutPage->section_three_tab_one_short_description }}</textarea>
                                                                    ...
                                                                    <div class="col-lg-3">
                                                                        <div class="fv-row mb-3">
                                                                            ...
                                                                            <input type="text" maxlength="220"
                                                                                ...
                                                                                value="{{ $aboutPage->section_three_tab_one_list_title }}"
                                                                                id="validationCustom01"
                                                                    ...
                                                                    <div class="col-lg-3">
                                                                        <div class="fv-row mb-3">
                                                                            ...
                                                                            <input type="text" maxlength="220"
                                                                                ...
                                                                                value="{{ $aboutPage->section_three_tab_one_list_1 }}"
                                                                                id="validationCustom01"
                                                                    ...
                                                                    <div class="col-lg-3">
                                                                        <div class="fv-row mb-3">
                                                                            ...
                                                                            <input type="text" maxlength="220"
                                                                                ...
                                                                                value="{{ $aboutPage->section_three_tab_one_list_2 }}"
                                                                                id="validationCustom01"
                                                                    ...
                                                                    <div class="col-lg-3">
                                                                        <div class="fv-row mb-3">
                                                                            ...
                                                                            <input type="text" maxlength="220"
                                                                                ...
                                                                                value="{{ $aboutPage->section_three_tab_one_list_3 }}"
                                                                                id="validationCustom01"
                                                                    ...
                                                                    <div class="col-lg-3">
                                                                        <div class="fv-row mb-3">
                                                                            ...
                                                                            <input type="text" maxlength="220"
                                                                                ...
                                                                                value="{{ $aboutPage->section_three_tab_one_list_4 }}"
                                                                                id="validationCustom01"
                                                                    ...
                                                                    <div class="col-lg-3">
                                                                        <div class="fv-row mb-3">
                                                                            ...
                                                                            <input type="text" maxlength="220"
                                                                                ...
                                                                                value="{{ $aboutPage->section_three_tab_one_quote }}"
                                                                    ...
                                                                    <div class="col-lg-3">
                                                                        <div class="fv-row mb-3">
                                                                            ...
                                                                            <input type="text" maxlength="220"
                                                                                ...
                                                                                value="{{ $aboutPage->section_three_tab_one_quote_author }}"
                                                                                id="validationCustom01"
                                                                    ...
                                                                    <div class="col-lg-3">
                                                                        <div class="fv-row mb-3">
                                                                            ...
                                                                            <input type="text" maxlength="220"
                                                                                ...
                                                                                value="{{ $aboutPage->section_three_tab_one_button_name }}"
                                                                                id="validationCustom01"
                                                                    ...
                                                                    <div class="col-lg-6">
                                                                        <div class="fv-row mb-3">
                                                                            ...
                                                                            <input type="url"
                                                                                ...
                                                                                value="{{ $aboutPage->section_three_tab_one_button_link }}"
                                                                                id="validationCustom01"
                                                                    ...
                                                                    <div class="col-lg-6">
                                                                        <div class="fv-row mb-3">
                                                                            ...
                                                                            <textarea rows="1" name="section_three_tab_one_detailed_description"
                                                                                ...
                                                                                placeholder="Enter Section Three Tab One Detailed Description">{{ $aboutPage->section_three_tab_one_detailed_description }}</textarea>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-lg-6">
                                                                        <div class="fv-row mb-3">
                                                                            ...
                                                                            <input type="text" maxlength="220"
                                                                                ...
                                                                                value="{{ $aboutPage->section_three_tab_two_title }}"
                                                                                id="validationCustom01"
                                                                    ...
                                                                    <div class="col-lg-6">
                                                                        <div class="fv-row mb-3">
                                                                            <label class="form-label">Section Three Tab two
                                                                                Short
                                                                                Description</label>
                                                                            <textarea rows="1" name="section_three_tab_two_short_description"
                                                                                class="form-control form-control-sm form-control-solid @error('section_three_tab_two_short_description') is-invalid @enderror"
                                                                                placeholder="Enter Section Three Tab two Short Description">{{ $aboutPage->section_three_tab_two_short_description }}</textarea>
                                                                    ...
                                                                    <div class="col-lg-3">
                                                                        <div class="fv-row mb-3">
                                                                            ...
                                                                            <input type="text" maxlength="220"
                                                                                ...
                                                                                value="{{ $aboutPage->section_three_tab_two_list_title }}"
                                                                                id="validationCustom01"
                                                                    ...
                                                                    <div class="col-lg-3">
                                                                        <div class="fv-row mb-3">
                                                                            ...
                                                                            <input type="text" maxlength="220"
                                                                                ...
                                                                                value="{{ $aboutPage->section_three_tab_two_list_1 }}"
                                                                                id="validationCustom01"
                                                                    ...
                                                                    <div class="col-lg-3">
                                                                        <div class="fv-row mb-3">
                                                                            ...
                                                                            <input type="text" maxlength="220"
                                                                                ...
                                                                                value="{{ $aboutPage->section_three_tab_two_list_2 }}"
                                                                                id="validationCustom01"
                                                                                placeholder="Enter Section Three Tab two List Two">
                                                                    ...
                                                                    <div class="col-lg-3">
                                                                        <div class="fv-row mb-3">
                                                                            ...
                                                                            <input type="text" maxlength="220"
                                                                                ...
                                                                                value="{{ $aboutPage->section_three_tab_two_list_3 }}"
                                                                                id="validationCustom01"
                                                                    ...
                                                                    <div class="col-lg-3">
                                                                        <div class="fv-row mb-3">
                                                                            ...
                                                                            <input type="text" maxlength="220"
                                                                                ...
                                                                                value="{{ $aboutPage->section_three_tab_two_list_4 }}"
                                                                                id="validationCustom01"
                                                                    ...
                                                                    <div class="col-lg-3">
                                                                        <div class="fv-row mb-3">
                                                                            ...
                                                                            <input type="text" maxlength="220"
                                                                                ...
                                                                                value="{{ $aboutPage->section_three_tab_two_quote }}"
                                                                                maxlength="250" id="validationCustom01"
                                                                    ...
                                                                    <div class="col-lg-3">
                                                                        <div class="fv-row mb-3">
                                                                            ...
                                                                            <input type="text" maxlength="220"
                                                                                ...
                                                                                value="{{ $aboutPage->section_three_tab_two_quote_author }}"
                                                                                id="validationCustom01"
                                                                    ...
                                                                    <div class="col-lg-3">
                                                                        <div class="fv-row mb-3">
                                                                            ...
                                                                            <input type="text" maxlength="220"
                                                                                ...
                                                                                value="{{ $aboutPage->section_three_tab_two_button_name }}"
                                                                                id="validationCustom01"
                                                                    ...
                                                                    <div class="col-lg-6">
                                                                        <div class="fv-row mb-3">
                                                                            ...
                                                                            <input type="url"
                                                                                ...
                                                                                value="{{ $aboutPage->section_three_tab_two_button_link }}"
                                                                                id="validationCustom01"
                                                                    ...
                                                                    <div class="col-lg-6">
                                                                        <div class="fv-row mb-3">
                                                                            <label class="form-label">Section Three Tab two
                                                                                Detailed Description</label>
                                                                            <textarea rows="1" name="section_three_tab_two_detailed_description"
                                                                                ...
                                                                                placeholder="Enter Section Three Tab two Detailed Description">{{ $aboutPage->section_three_tab_two_detailed_description }}</textarea>
                                                                    ...
                                                                    <div class="col-lg-6">
                                                                        <div class="fv-row mb-3">
                                                                            ...
                                                                            <input type="text" maxlength="220"
                                                                                ...
                                                                                value="{{ $aboutPage->section_three_tab_three_title }}"
                                                                                id="validationCustom01"
                                                                    ...
                                                                    <div class="col-lg-6">
                                                                        <div class="fv-row mb-3">
                                                                            <label class="form-label">Section Three Tab
                                                                                three Short
                                                                                Description</label>
                                                                            <textarea rows="1" name="section_three_tab_three_short_description"
                                                                                ...
                                                                                placeholder="Enter Section Three Tab three Short Description">{{ $aboutPage->section_three_tab_three_short_description }}</textarea>
                                                                    ...
                                                                    <div class="col-lg-3">
                                                                        <div class="fv-row mb-3">
                                                                            ...
                                                                            <input type="text" maxlength="220"
                                                                                ...
                                                                                value="{{ $aboutPage->section_three_tab_three_list_title }}"
                                                                                id="validationCustom01"
                                                                    ...
                                                                    <div class="col-lg-3">
                                                                        <div class="fv-row mb-3">
                                                                            ...
                                                                            <input type="text" maxlength="220"
                                                                                ...
                                                                                value="{{ $aboutPage->section_three_tab_three_list_1 }}"
                                                                                id="validationCustom01"
                                                                    ...
                                                                    <div class="col-lg-3">
                                                                        <div class="fv-row mb-3">
                                                                            ...
                                                                            <input type="text" maxlength="220"
                                                                                ...
                                                                                value="{{ $aboutPage->section_three_tab_three_list_2 }}"
                                                                                id="validationCustom01"
                                                                                placeholder="Enter Section Three Tab three List three">
                                                                    ...
                                                                    <div class="col-lg-3">
                                                                        <div class="fv-row mb-3">
                                                                            ...
                                                                            <input type="text"
                                                                                ...
                                                                                value="{{ $aboutPage->section_three_tab_three_list_3 }}"
                                                                                id="validationCustom01" maxlength="220"
                                                                                placeholder="Enter Section Three Tab three List Three">
                                                                    ...
                                                                    <div class="col-lg-3">
                                                                        <div class="fv-row mb-3">
                                                                            ...
                                                                            <input type="text"
                                                                                ...
                                                                                value="{{ $aboutPage->section_three_tab_three_list_4 }}"
                                                                                id="validationCustom01" maxlength="220"
                                                                    ...
                                                                    <div class="col-lg-3">
                                                                        <div class="fv-row mb-3">
                                                                            ...
                                                                            <input type="text"
                                                                                ...
                                                                                value="{{ $aboutPage->section_three_tab_three_quote }}"
                                                                                id="validationCustom01"
                                                                    ...
                                                                    <div class="col-lg-3">
                                                                        <div class="fv-row mb-3">
                                                                            ...
                                                                            <input type="text"
                                                                                ...
                                                                                value="{{ $aboutPage->section_three_tab_three_quote_author }}"
                                                                                id="validationCustom01" maxlength="220"
                                                                    ...
                                                                    <div class="col-lg-3">
                                                                        <div class="fv-row mb-3">
                                                                            ...
                                                                            <input type="text"
                                                                                ...
                                                                                value="{{ $aboutPage->section_three_tab_three_button_name }}"
                                                                                id="validationCustom01" maxlength="220"
                                                                    ...
                                                                    <div class="col-lg-6">
                                                                        <div class="fv-row mb-3">
                                                                            ...
                                                                            <input type="url"
                                                                                ...
                                                                                value="{{ $aboutPage->section_three_tab_three_button_link }}"
                                                                                id="validationCustom01"
                                                                    ...
                                                                    <div class="col-lg-6">
                                                                        <div class="fv-row mb-3">
                                                                            <label class="form-label">Section Three Tab
                                                                                Three
                                                                                Detailed Description</label>
                                                                            <textarea rows="1" name="section_three_tab_three_detailed_description"
                                                                                ...
                                                                                placeholder="Enter Section Three Tab three Detailed Description">{{ $aboutPage->section_three_tab_three_detailed_description }}</textarea>
                                                                    ...
                                                                    <div class="col-lg-6">
                                                                        <div class="fv-row mb-3">
                                                                            ...
                                                                            <input type="text" maxlength="220"
                                                                                ...
                                                                                value="{{ $aboutPage->section_three_tab_four_title }}"
                                                                                id="validationCustom01"
                                                                                placeholder="Enter Section Three Tab Three Title">
                                                                    ...
                                                                    <div class="col-lg-6">
                                                                        <div class="fv-row mb-3">
                                                                            <label class="form-label">Section Three Tab
                                                                                ...
                                                                                Short
                                                                                Description</label>
                                                                            <textarea rows="1" name="section_three_tab_four_short_description"
                                                                                class="form-control form-control-sm form-control-solid @error('section_three_tab_four_short_description') is-invalid @enderror"
                                                                                placeholder="Enter Section Three Tab Four Short Description">{{ $aboutPage->section_three_tab_four_short_description }}</textarea>
                                                                    ...
                                                                    <div class="col-lg-3">
                                                                        <div class="fv-row mb-3">
                                                                            ...
                                                                            <input type="text" maxlength="220"
                                                                                ...
                                                                                value="{{ $aboutPage->section_three_tab_four_list_title }}"
                                                                                id="validationCustom01"
                                                                    ...
                                                                    <div class="col-lg-3">
                                                                        <div class="fv-row mb-3">
                                                                            ...
                                                                            <input type="text" maxlength="220"
                                                                                ...
                                                                                value="{{ $aboutPage->section_three_tab_four_list_1 }}"
                                                                                id="validationCustom01"
                                                                    ...
                                                                    <div class="col-lg-3">
                                                                        <div class="fv-row mb-3">
                                                                            ...
                                                                            <input type="text" maxlength="220"
                                                                                ...
                                                                                value="{{ $aboutPage->section_three_tab_four_list_2 }}"
                                                                                id="validationCustom01"
                                                                                placeholder="Enter Section Three Tab four List four">
                                                                    ...
                                                                    <div class="col-lg-3">
                                                                        <div class="fv-row mb-3">
                                                                            ...
                                                                            <input type="text" maxlength="220"
                                                                                ...
                                                                                value="{{ $aboutPage->section_three_tab_four_list_3 }}"
                                                                                id="validationCustom01"
                                                                                placeholder="Enter Section Three Tab four List four">
                                                                    ...
                                                                    <div class="col-lg-3">
                                                                        <div class="fv-row mb-3">
                                                                            ...
                                                                            <input type="text" maxlength="220"
                                                                                ...
                                                                                value="{{ $aboutPage->section_three_tab_four_list_4 }}"
                                                                                id="validationCustom01"
                                                                                placeholder="Enter Section Three Tab four List Four">
                                                                    ...
                                                                    <div class="col-lg-3">
                                                                        <div class="fv-row mb-3">
                                                                            ...
                                                                            <input type="text" maxlength="220"
                                                                                ...
                                                                                value="{{ $aboutPage->section_three_tab_four_quote }}"
                                                                                id="validationCustom01"
                                                                    ...
                                                                    <div class="col-lg-3">
                                                                        <div class="fv-row mb-3">
                                                                            ...
                                                                            <input type="text" maxlength="220"
                                                                                ...
                                                                                value="{{ $aboutPage->section_three_tab_four_quote_author }}"
                                                                                id="validationCustom01"
                                                                    ...
                                                                    <div class="col-lg-3">
                                                                        <div class="fv-row mb-3">
                                                                            ...
                                                                            <input type="text" maxlength="220"
                                                                                ...
                                                                                value="{{ $aboutPage->section_three_tab_four_button_name }}"
                                                                                id="validationCustom01"
                                                                    ...
                                                                    <div class="col-lg-6">
                                                                        <div class="fv-row mb-3">
                                                                            ...
                                                                            <input type="url"
                                                                                ...
                                                                                value="{{ $aboutPage->section_three_tab_four_button_link }}"
                                                                                id="validationCustom01"
                                                                    ...
                                                                    <div class="col-lg-6">
                                                                        <div class="fv-row mb-3">
                                                                            <label class="form-label">Section Three Tab
                                                                                four
                                                                                Detailed Description</label>
                                                                            <textarea rows="1" name="section_three_tab_four_detailed_description"
                                                                                ...
                                                                                placeholder="Enter Section Three Tab four Detailed Description">{{ $aboutPage->section_three_tab_four_detailed_description }}</textarea>
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="fv-row mb-3">
                                                            ...
                                                            <input type="file"
                                                                ...
                                                                value="{{ $aboutPage->section_four_banner_middle_image }}"
                                                                id="validationCustom01"
                                            ...
                                            <div class="fv-row">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-3">
                                                                <div class="fv-row mb-3">
                                                                    ...
                                                                    <input type="text" maxlength="220"
                                                                        ...
                                                                        value="{{ $aboutPage->section_five_col_one_title }}"
                                                                        id="validationCustom01"
                                                            ...
                                                            <div class="col-lg-3">
                                                                <div class="fv-row mb-3">
                                                                    ...
                                                                    <input type="file"
                                                                        ...
                                                                        name="section_five_ceo_sign"
                                                                        value="{{ $aboutPage->section_five_ceo_sign }}"
                                                                        id="validationCustom01"
                                                            ...
                                                            <div class="col-lg-3">
                                                                <div class="fv-row mb-3">
                                                                    ...
                                                                    <input type="text" maxlength="220"
                                                                        ...
                                                                        name="section_five_ceo_name"
                                                                        value="{{ $aboutPage->section_five_ceo_name }}"
                                                                        id="validationCustom01"
                                                            ...
                                                            <div class="col-lg-3">
                                                                <div class="fv-row mb-3">
                                                                    ...
                                                                    <input type="text" maxlength="220"
                                                                        ...
                                                                        value="{{ $aboutPage->section_five_ceo_designation }}"
                                                                        id="validationCustom01"
                                                            ...
                                                            <div class="col-lg-4">
                                                                <div class="fv-row mb-3">
                                                                    ...
                                                                    <input type="url"
                                                                        ...
                                                                        value="{{ $aboutPage->section_five_ceo_facebook_account_link }}"
                                                                        id="validationCustom01"
                                                            ...
                                                            <div class="col-lg-4">
                                                                <div class="fv-row mb-3">
                                                                    ...
                                                                    <input type="url"
                                                                        ...
                                                                        value="{{ $aboutPage->section_five_ceo_twitter_account_link }}"
                                                                        id="validationCustom01"
                                                            ...
                                                            <div class="col-lg-4">
                                                                <div class="fv-row mb-3">
                                                                    ...
                                                                    <input type="url"
                                                                        ...
                                                                        value="{{ $aboutPage->section_five_ceo_whatsapp_account_link }}"
                                                                        id="validationCustom01"
                                                            ...
                                                            <div class="col-lg-12">
                                                                <div class="fv-row mb-3">
                                                                    <label class="form-label">Section Five Col One
                                                                        Description</label>
                                                                    <textarea rows="1" name="section_five_col_one_description"
                                                                        class="form-control form-control-sm form-control-solid @error('section_five_col_one_description') is-invalid @enderror"
                                                                        placeholder="Enter Section Five Col One Description">{{ $aboutPage->section_five_col_one_description }}</textarea>
                                                            ...
                                                            <div class="col-lg-3">
                                                                <div class="fv-row mb-3">
                                                                    ...
                                                                    <input type="text" maxlength="220"
                                                                        ...
                                                                        value="{{ $aboutPage->section_five_col_two_title }}"
                                                                        id="validationCustom01"
                                                                        placeholder="Enter Section Five Col One Title">
                                                            ...
                                                            <div class="col-lg-3">
                                                                <div class="fv-row mb-3">
                                                                    ...
                                                                    <input type="text" maxlength="220"
                                                                        ...
                                                                        value="{{ $aboutPage->section_five_col_two_list_1 }}"
                                                                        id="validationCustom01"
                                                                        placeholder="Enter Section Five Col One Title">
                                                            ...
                                                            <div class="col-lg-3">
                                                                <div class="fv-row mb-3">
                                                                    ...
                                                                    <input type="text" maxlength="220"
                                                                        ...
                                                                        value="{{ $aboutPage->section_five_col_two_list_2 }}"
                                                                        id="validationCustom01"
                                                                        placeholder="Enter Section Five Col One Title">
                                                            ...
                                                            <div class="col-lg-3">
                                                                <div class="fv-row mb-3">
                                                                    ...
                                                                    <input type="text" maxlength="220"
                                                                        ...
                                                                        value="{{ $aboutPage->section_five_col_two_list_3 }}"
                                                                        id="validationCustom01"
                                                                        placeholder="Enter Section Five Col One Title">
                                                            ...
                                                            <div class="col-lg-3">
                                                                <div class="fv-row mb-3">
                                                                    ...
                                                                    <input type="text" maxlength="220"
                                                                        ...
                                                                        value="{{ $aboutPage->section_five_col_two_list_4 }}"
                                                                        id="validationCustom01"
                                                                        placeholder="Enter Section Five Col One Title">
                                                            ...
                                                            <div class="col-lg-9">
                                                                <div class="fv-row mb-3">
                                                                    ...
                                                                    @error('section_five_col_two_content') is-invalid @enderror"
                                                                        placeholder="Enter Section Five Col Two Content">{{ $aboutPage->section_five_col_two_content }}</textarea>
                                                ...
                                                <div class="row mt-2 justify-content-end">
                                                    <div class="d-flex align-items-center justify-content-between p-0">
                                                        <a class="btn btn-lg btn-info rounded-0 tab-trigger-previous"
                                                            data-bs-target="#section-four" aria-selected="false"
                                                            role="tab" tabindex="-1">
                                                            Previous
                                                            <span class="svg-icon svg-icon-4 ms-1 me-0">
                                                                <i class="fa-solid fa-arrow-right"></i>
                                        ...
                                        <div class="w-100">
                                            ...
                                            <div class="fv-row">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-lg-4">
                                                                        <div class="fv-row mb-3">
                                                                            ...
                                                                            <input type="text" maxlength="220"
                                                                                ...
                                                                                value="{{ $aboutPage->section_six_card_one_title }}"
                                                                                id="validationCustom01"
                                                                    ...
                                                                    <div class="col-lg-4">
                                                                        <div class="fv-row mb-3">
                                                                            ...
                                                                            <input type="text" maxlength="220"
                                                                                ...
                                                                                value="{{ $aboutPage->section_six_card_one_count }}"
                                                                                id="validationCustom01"
                                                                    ...
                                                                    <div class="col-lg-4">
                                                                        <div class="fv-row mb-3">
                                                                            ...
                                                                            <input type="text" maxlength="220"
                                                                                ...
                                                                                value="{{ $aboutPage->section_six_card_one_icon }}"
                                                                                id="validationCustom01"
                                                                    ...
                                                                    <div class="col-lg-12">
                                                                        <div class="fv-row mb-3">
                                                                            ...
                                                                            <textarea rows="1" name="section_six_card_one_short_description"
                                                                                class="form-control form-control-sm form-control-solid @error('section_six_card_one_short_description') is-invalid @enderror"
                                                                                placeholder="Enter Section Six Card One Short Description">{{ $aboutPage->section_six_card_one_short_description }}</textarea>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-lg-4">
                                                                        <div class="fv-row mb-3">
                                                                            ...
                                                                            <input type="text" maxlength="220"
                                                                                ...
                                                                                value="{{ $aboutPage->section_six_card_two_title }}"
                                                                                id="validationCustom01"
                                                                    ...
                                                                    <div class="col-lg-4">
                                                                        <div class="fv-row mb-3">
                                                                            ...
                                                                            <input type="text" maxlength="220"
                                                                                ...
                                                                                value="{{ $aboutPage->section_six_card_two_count }}"
                                                                                id="validationCustom01"
                                                                    ...
                                                                    <div class="col-lg-4">
                                                                        <div class="fv-row mb-3">
                                                                            ...
                                                                            <input type="text" maxlength="220"
                                                                                ...
                                                                                value="{{ $aboutPage->section_six_card_two_icon }}"
                                                                                id="validationCustom01"
                                                                    ...
                                                                    <div class="col-lg-12">
                                                                        <div class="fv-row mb-3">
                                                                            <label class="form-label">Section Six Card Two
                                                                                Short Description</label>
                                                                            <textarea rows="1" name="section_six_card_two_short_description"
                                                                                class="form-control form-control-sm form-control-solid @error('section_six_card_two_short_description') is-invalid @enderror"
                                                                                placeholder="Enter Section Six Card two Short Description">{{ $aboutPage->section_six_card_two_short_description }}</textarea>
                                                        ...
                                                        <div class="row border p-4">
                                                            ...
                                                            <div class="col-lg-12">
                                                                <div class="row">
                                                                    <div class="col-lg-4">
                                                                        <div class="fv-row mb-3">
                                                                            <label class="form-label">Section Six Card
                                                                                Three
                                                                                Title</label>
                                                                            <input type="text" maxlength="220"
                                                                                ...
                                                                                value="{{ $aboutPage->section_six_card_three_title }}"
                                                                                id="validationCustom01"
                                                                    ...
                                                                    <div class="col-lg-4">
                                                                        <div class="fv-row mb-3">
                                                                            ...
                                                                            <input type="text" maxlength="220"
                                                                                ...
                                                                                value="{{ $aboutPage->section_six_card_three_count }}"
                                                                                id="validationCustom01"
                                                                    ...
                                                                    <div class="col-lg-4">
                                                                        <div class="fv-row mb-3">
                                                                            ...
                                                                            <input type="text" maxlength="220"
                                                                                ...
                                                                                value="{{ $aboutPage->section_six_card_three_icon }}"
                                                                                id="validationCustom01"
                                                                    ...
                                                                    <div class="col-lg-12">
                                                                        <div class="fv-row mb-3">
                                                                            <label class="form-label">Section Six Card
                                                                                Three
                                                                                Short Description</label>
                                                                            <textarea rows="1" name="section_six_card_three_short_description"
                                                                                class="form-control form-control-sm form-control-solid @error('section_six_card_three_short_description') is-invalid @enderror"
                                                                                placeholder="Enter Section Six Card Three Short Description">{{ $aboutPage->section_six_card_three_short_description }}</textarea>
                                                                    ...
                                                                    <div class="col-lg-4">
                                                                        <div class="fv-row mb-3">
                                                                            ...
                                                                            <input type="text" maxlength="220"
                                                                                ...
                                                                                value="{{ $aboutPage->section_six_card_four_title }}"
                                                                                id="validationCustom01"
                                                                    ...
                                                                    <div class="col-lg-4">
                                                                        <div class="fv-row mb-3">
                                                                            ...
                                                                            <input type="text" maxlength="220"
                                                                                ...
                                                                                value="{{ $aboutPage->section_six_card_four_count }}"
                                                                                id="validationCustom01"
                                                                    ...
                                                                    <div class="col-lg-4">
                                                                        <div class="fv-row mb-3">
                                                                            ...
                                                                            <input type="text" maxlength="220"
                                                                                ...
                                                                                value="{{ $aboutPage->section_six_card_four_icon }}"
                                                                                id="validationCustom01"
                                                                    ...
                                                                    <div class="col-lg-12">
                                                                        <div class="fv-row mb-3">
                                                                            <label class="form-label">Section Six Card
                                                                                four
                                                                                Short Description</label>
                                                                            <textarea rows="1" name="section_six_card_four_short_description"
                                                                                class="form-control form-control-sm form-control-solid @error('section_six_card_four_short_description') is-invalid @enderror"
                                                                                placeholder="Enter Section Six Card Four Short Description">{{ $aboutPage->section_six_card_four_short_description }}</textarea>
                                                ...
                                                <div class="row mt-2 justify-content-end">
                                                    <div class="d-flex align-items-center justify-content-between p-0">
                                                        <a class="btn btn-lg btn-info rounded-0 tab-trigger-previous"
                                                            data-bs-target="#section-five" aria-selected="false"
                                                            role="tab" tabindex="-1">
                                                            Previous
                                                            <span class="svg-icon svg-icon-4 ms-1 me-0">
                                                                <i class="fa-solid fa-arrow-right"></i>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <select
                                                            ...
                                                            <option></option>
                                                            <option @selected($aboutPage->status == 'active') value="active">Active
                                                            </option>
                                                            <option @selected($aboutPage->status == 'inactive') value="inactive">In
                                                                Active</option>
                                                        </select>
                                                        @error('status')
                                                            <div class="invalid-feedback d-block">{{ $message }}</div>
