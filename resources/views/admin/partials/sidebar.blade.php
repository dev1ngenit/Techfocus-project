    ...
    <div class="aside-menu flex-column-fluid">
        ...
        <div class="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true"
            ...
            <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
                ...
                @php
                    $hr_admin = ['admin.task.index','admin.employee-task.index','admin.leave-application.history','admin.hr.dashboard', 'admin.employee-category.index', 'admin.employee-department.index', 'admin.employee.index','admin.leave-application.index','admin.leave-application.create','admin.leave-application.edit'];
                @endphp
                <div data-kt-menu-trigger="click"
                    ...
                    <div class="menu-sub menu-sub-accordion">
                        ...
                        <div data-kt-menu-trigger="click"
                            class="menu-item menu-accordion {{ in_array(Route::current()->getName(), ['admin.leave-application.history','admin.leave-application.index','admin.leave-application.create','admin.leave-application.edit']) ? 'here show' : '' }}">
                            <span class="menu-link">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                            ...
                            <div class="menu-sub menu-sub-accordion">
                                <div class="menu-item">
                                    <a class="menu-link {{ Route::current()->getName() == 'admin.leave-application.index' ? 'active' : '' }}"
                                        href="{{ route('admin.leave-application.index') }}">
                                        <span class="menu-bullet">
                                            <span class="bullet bullet-dot"></span>
                                        </span>
                                ...
                                <div class="menu-item">
                                    <a class="menu-link {{ Route::current()->getName() == 'admin.leave-application.history' ? 'active' : '' }}"
                                        href="{{ route('admin.leave-application.history') }}">
                                        <span class="menu-bullet">
                                            <span class="bullet bullet-dot"></span>
                                        </span>
                        ...
                        <div class="menu-item">
                            <a class="menu-link {{ in_array(Route::current()->getName(), ['admin.employee-project.index','admin.employee-project.create','admin.employee-project.edit']) ? 'active' : '' }}" 
                                href="{{ route('admin.employee-project.index') }}">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                            ...
                            <div class="menu-sub menu-sub-accordion">
                                <div class="menu-item">
                                    <a class="menu-link {{ Route::current()->getName() == 'admin.employee-task.index' ? 'active' : '' }}"
                                        ...
                                        <span class="menu-title">Monthly Task Set</span>
                                    </a>
                                </div>
                                <div class="menu-item">
                                    <a class="menu-link {{ Route::current()->getName() == '' ? 'active' : '' }}"
                                        href="{{ route('admin.task.index') }}">
                                        <span class="menu-bullet">
                                            <span class="bullet bullet-dot"></span>
                                        </span>
                                        <span class="menu-title">Daily Agenda</span>
                                    </a>
                                </div>
                            </div>
                        </div>
                ...
                <div data-kt-menu-trigger="click"
                    ...
                    <div class="menu-sub menu-sub-accordion">
                        <div class="menu-item">
                            <a class="menu-link {{ Route::current()->getName() == 'admin.web.setting' ? 'active' : '' }}" href="{{ route('admin.web.setting') }}">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
