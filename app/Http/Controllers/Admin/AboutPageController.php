...
class AboutPageController extends Controller
{
    ...
    public function store(AboutPageRequest $request)
    {
        ...
        AboutPage::create([
            ...
            'section_six_card_one_short_description'   => $request->section_six_card_one_short_description,
            'section_six_card_two_title'               => $request->section_six_card_two_title,
            'section_six_card_two_count'               => $request->section_six_card_two_count,
            'section_six_card_two_icon'                => $request->section_six_card_two_icon,
