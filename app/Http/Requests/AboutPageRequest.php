...
class AboutPageRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'section_two_main_image' =>  'nullable|image|mimes:jpeg,png,jpg|max:2048',
            'section_two_secondary_image' => 'nullable|image|mimes:jpeg,png,jpg|max:2048',
            ...
            'section_four_banner_middle_image' => 'nullable|image|mimes:jpeg,png,jpg|max:2048',
            'section_five_col_one_description' => 'required|string',
            'section_five_col_one_title' => 'required|string|max:230',
            'section_five_ceo_sign' => 'nullable|image|mimes:jpeg,png,jpg|max:2048',
